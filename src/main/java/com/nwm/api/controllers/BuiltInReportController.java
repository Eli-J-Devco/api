...
public class BuiltInReportController extends BaseController {
	...
	private static void writeHeaderAnnuallyReport(Sheet sheet, int rowIndex, ArrayList categories, ArrayList actualGeneration, ViewReportEntity dataObj, ArrayList dataExpectedGeneration, ArrayList dataModeledGeneration, ArrayList dataPOA, ArrayList dataExpectedGenerationIndex, ArrayList dataModeledGenerationIndex, double totalActualGeneration, double totalExpectedGeneration, double totalModeledGeneration, double totalExpectedGenerationIndex, double totalModeledGenerationIndex) {
		try {
			...
			cell2.setCellValue("COSTCO - HUNTINGTON BEACH #1110");
			...
			cell3.setCellValue("05/01/2022 - 05/31/2023");
			...
			cell65.setCellValue(df.format(totalExpectedGenerationIndex));
			...
			cell66.setCellValue(df.format(totalModeledGenerationIndex));
	...
	public Object sentMailDailyReport(@RequestBody ViewReportEntity obj) {
		try {
			...
			obj.setStart_date("2023-01-01 00:00:00");
			obj.setEnd_date("2023-07-30 23:59:00");
			if(sites.size() > 0) {
...
//							series.setTitle("Actual Generation (kWh)", new CellReference(chartSheet.getSheetName(), 5, 2, true, true));
...
//						dataObj.setEnd_date(format.format(calQ.getTime()));
//						
//						XSSFSheet chartSheet = document.createSheet("Annual Production Trend Report");
