...
public class DeviceEntity {
	...
	public String toString() {
		return "DeviceEntity{" +
				...
				", timezone='" + timezone + '\'' +
				", hash_id_site='" + hash_id_site + '\'' +
				", total_error=" + total_error +
				", total_tracker=" + total_tracker +
				", groupMeter=" + groupMeter +
				", groupInverter=" + groupInverter +
				...
				", order_id=" + order_id +
				", read_data_all='" + read_data_all + '\'' +
				", view_tablename='" + view_tablename + '\'' +
				", con_power=" + con_power +
				", con_setpoint=" + con_setpoint +
				", con_temp=" + con_temp +
				...
				", id_device_parameter=" + id_device_parameter +
				", command='" + command + '\'' +
				...
				", datalogger_table='" + datalogger_table + '\'' +
				...
				", device_ftp_server='" + device_ftp_server + '\'' +
				", device_ftp_user='" + device_ftp_user + '\'' +
				", device_ftp_pass='" + device_ftp_pass + '\'' +
				", device_ftp_port='" + device_ftp_port + '\'' +
				", device_ftp_folder='" + device_ftp_folder + '\'' +
				", datalogger_type=" + datalogger_type +
				", power_now=" + power_now +
				", table_share_data='" + table_share_data + '\'' +
				", id_device_share=" + id_device_share +
				", id_site_share=" + id_site_share +
				", filterEnabled=" + filterEnabled +
				", maxPower=" + maxPower +
				", offset_data_old=" + offset_data_old +
				", date_time_offset='" + date_time_offset + '\'' +
				", is_excluded_meter=" + is_excluded_meter +
				...
				", is_excluded_in_report=" + is_excluded_in_report +
				", is_excluded_irradiance_in_report=" + is_excluded_irradiance_in_report +
				", is_excluded_temp_in_report=" + is_excluded_temp_in_report +
				", parameters=" + parameters +
				", ai_train_type=" + ai_train_type +
				", listDataMaps=" + listDataMaps +
				", datas=" + datas +
				", deviceIds=" + deviceIds +
				", siteIds=" + siteIds +
				", is_tracker_master=" + is_tracker_master +
				", create_total_device=" + create_total_device +
				'}';
	}
}
