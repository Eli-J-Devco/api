 ...
 *
 * Each model provides a list of BitCodeFaultConfig — one per fault code field.
 * Data fetching (2-hour window) is handled centrally by TriggerAlertBitCodeService
 * via CronJobAlertField.getBitCodeDataIn2Hours.
 *
 * @author duc.pham
 * @since 2026-04-24
 */
