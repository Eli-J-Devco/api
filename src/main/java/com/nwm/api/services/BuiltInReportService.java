...
public class BuiltInReportService extends DB {
	...
	public Object getAnnuallyBuitInReport(ViewReportEntity obj) {
		...
		try {
//			dataObj = (ViewReportEntity) queryForObject("BuiltInReport.getDetailReport", obj);
//			if (dataObj == null) {
//				return null;
//			}
...
//			List dataEnergy = queryForList("BuiltInReport.getDataEnergyAnnuallyReport", obj);
//			
...
//				List dataAvailability = queryForList("BuiltInReport.getInverterAvailability", obj);
//				dataObj.setDataAvailability(dataAvailability);
//				dataObj.setDeviceType("inverter");
//			} else {
//				List dataAvailability = queryForList("BuiltInReport.getMeterAvailability", obj);
//				dataObj.setDataAvailability(dataAvailability);
//				dataObj.setDeviceType("meter");
//			}
//			
//			List dataEnergyExpectations = queryForList("BuiltInReport.getReportEnergyExpectations", obj);
