...
public class ModelLovatoDmg800Service extends DB {
	/**
	...
	public ModelLovatoDmg800Entity setModelLovatoDmg800(String line) {
		try {
			...
			if (words.size() > 0) {
				...
				dataModel.setL1phasevoltage(Double.parseDouble(!Lib.isBlank(words.get(4)) ? words.get(4) : "0.001"));
				dataModel.setL2phasevoltage(Double.parseDouble(!Lib.isBlank(words.get(5)) ? words.get(5) : "0.001"));
				dataModel.setL3phasevoltage(Double.parseDouble(!Lib.isBlank(words.get(6)) ? words.get(6) : "0.001"));
				dataModel.setL1current(Double.parseDouble(!Lib.isBlank(words.get(7)) ? words.get(7) : "0.001"));
				dataModel.setL2current(Double.parseDouble(!Lib.isBlank(words.get(8)) ? words.get(8) : "0.001"));
				dataModel.setL3current(Double.parseDouble(!Lib.isBlank(words.get(9)) ? words.get(9) : "0.001"));
				dataModel.setL1L2voltage(Double.parseDouble(!Lib.isBlank(words.get(10)) ? words.get(10) : "0.001"));
				
				dataModel.setL2L3voltage(Double.parseDouble(!Lib.isBlank(words.get(11)) ? words.get(11) : "0.001"));
				dataModel.setL3L1voltage(Double.parseDouble(!Lib.isBlank(words.get(12)) ? words.get(12) : "0.001"));
				dataModel.setL1activepower(Double.parseDouble(!Lib.isBlank(words.get(13)) ? words.get(13) : "0.001"));
				dataModel.setL2activepower(Double.parseDouble(!Lib.isBlank(words.get(14)) ? words.get(14) : "0.001"));
				dataModel.setL3activepower(Double.parseDouble(!Lib.isBlank(words.get(15)) ? words.get(15) : "0.001"));
				dataModel.setL1reactivepower(Double.parseDouble(!Lib.isBlank(words.get(16)) ? words.get(16) : "0.001"));
				dataModel.setL2reactivepower(Double.parseDouble(!Lib.isBlank(words.get(17)) ? words.get(17) : "0.001"));
				dataModel.setL3reactivepower(Double.parseDouble(!Lib.isBlank(words.get(18)) ? words.get(18) : "0.001"));
				dataModel.setL1apparentpower(Double.parseDouble(!Lib.isBlank(words.get(19)) ? words.get(19) : "0.001"));
				
				dataModel.setL2apparentpower(Double.parseDouble(!Lib.isBlank(words.get(20)) ? words.get(20) : "0.001"));
				dataModel.setL3apparentpower(Double.parseDouble(!Lib.isBlank(words.get(21)) ? words.get(21) : "0.001"));
				dataModel.setL1powerfactor(Double.parseDouble(!Lib.isBlank(words.get(22)) ? words.get(22) : "0.001"));
				...
				dataModel.setEqvReactivepower(Double.parseDouble(!Lib.isBlank(words.get(30)) ? words.get(30) : "0.001"));
				
				dataModel.setEqvApparentpower(Double.parseDouble(!Lib.isBlank(words.get(31)) ? words.get(31) : "0.001"));
				dataModel.setEqvpowerfactor(Double.parseDouble(!Lib.isBlank(words.get(32)) ? words.get(32) : "0.001"));
				...
				return new ModelLovatoDmg800Entity();
			}
	...
	public boolean insertModelLovatoDmg800(ModelLovatoDmg800Entity obj) {
		try {
			ModelLovatoDmg800Entity dataObj = (ModelLovatoDmg800Entity) queryForObject("ModelLovatoDmg800.getLastRow", obj);
		 	...
		 	Object insertId = insert("ModelLovatoDmg800.insertModelLovatoDmg800", obj);
	        if(insertId == null ) {
	        	return false;
	        }
