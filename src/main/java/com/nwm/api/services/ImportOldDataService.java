...
public class ImportOldDataService extends DB {
	...
	public Object setModelDent48pshdMeter(HashMap<String, String> rowItem, Row r) {
		...
		rowItem.put("nvmActivePower", !r.getCellText(95).toString().equals("") ? r.getCellText(95).toString() : "0.001");
		rowItem.put("nvmActiveEnergy", !r.getCellText(96).toString().equals("") ? r.getCellText(96).toString() : "0.001");
		rowItem.put("MeasuredProduction", !r.getCellText(97).toString().equals("") ? r.getCellText(97).toString() : "0.001");
