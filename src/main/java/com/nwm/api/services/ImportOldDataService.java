...
public class ImportOldDataService extends DB {
		...
		try {
			...
			case "model_xgi150":
				...
				for (int i = 0; i < dataList.size(); i++) {
					session.insert("ModelXGI1500.insertModelXGI1500", dataList.get(i));					
				}			
				break;
			...
			case "model_elkor_production_meterv1":
				obj.setId_device_type(3);
				for (int i = 0; i < dataList.size(); i++) {
					session.insert("ModelElkorProductionMeterv1.insertModelElkorProductionMeterv1", dataList.get(i));
				}
				break;
			...
			case "model_solaredge_inverter_v1":
				obj.setId_device_type(1);
				for (int i = 0; i < dataList.size(); i++) {
					session.insert("ModelSolarEdgeInverterV1.insertModelSolarEdgeInverterV1", dataList.get(i));					
				}				
				break;
			...
			case "model_dent_48pshd_meter":
				obj.setId_device_type(3);
				for (int i = 0; i < dataList.size(); i++) {
					session.insert("ModelDent48PSHDMeter.insertModelDent48PSHDMeter", dataList.get(i));         
				}
				break;
			case "model_power_logic_pm8000_load_meter":
				obj.setId_device_type(3);
				for (int i = 0; i < dataList.size(); i++) {
					session.insert("ModelPowerLogicPM8000LoadMeter.insertModelPowerLogicPM8000LoadMeter", dataList.get(i));         
				}
				break;
			case "model_honeywell_emon_3200":
				obj.setId_device_type(3);
				for (int i = 0; i < dataList.size(); i++) {
					session.insert("ModelHoneywellEMON3200.insert", dataList.get(i));
				}
				break;
			...
			case "model_QUINT4_UPS":
				obj.setId_device_type(13);
				for (int i = 0; i < dataList.size(); i++) {
					session.insert("ModelQuint4UPS.insertModelQuint4UPS", dataList.get(i));
				}
				break;
			...
			case "model_huawei_sun2000_28ktl":
				obj.setId_device_type(1);
				for (int i = 0; i < dataList.size(); i++) {
					session.insert("ModelHuaweiSun200028ktl.insertModelHuaweiSun200028ktl", dataList.get(i));
				}
				break;
			...
			case "model_smartlogger3000":
				obj.setId_device_type(3);
				for (int i = 0; i < dataList.size(); i++) {
					session.insert("ModelSmartLogger3000.insertModelSmartLogger3000", dataList.get(i));
				}
				break;
			...
			case "model_ginlong_solis_inverter_class6007":
				obj.setId_device_type(1);
				for (int i = 0; i < dataList.size(); i++) {
					session.insert("ModelGinlongSolisInverterClass6007.insertModelGinlongSolisInverterClass6007", dataList.get(i));
				}
				break;
			case "model_imtsolar_tv_class8004":
				obj.setId_device_type(4);
				for (int i = 0; i < dataList.size(); i++) {
					session.insert("ModelIMTSolarTvClass8004.insertModelIMTSolarTvClass8004", dataList.get(i));
				}
				break;
			...
			case "model_shark250":
				obj.setId_device_type(3);
				for (int i = 0; i < dataList.size(); i++) {
					session.insert("ModelShark250.insertModelShark250", dataList.get(i));
				}
				break;	
	...
	public Object setModelXGI150(HashMap<String, String> rowItem, Row r) {
		rowItem.put("ACCurrentAverage", !r.getCellText(6).toString().equals("") ? r.getCellText(6).toString() : "0.001");
		rowItem.put("ACCurrentA", !r.getCellText(7).toString().equals("") ? r.getCellText(7).toString() : "0.001");
		rowItem.put("ACCurrentB", !r.getCellText(8).toString().equals("") ? r.getCellText(8).toString() : "0.001");
		rowItem.put("ACCurrentC", !r.getCellText(9).toString().equals("") ? r.getCellText(9).toString() : "0.001");
		rowItem.put("ACVoltageAB", !r.getCellText(10).toString().equals("") ? r.getCellText(10).toString() : "0.001");
		rowItem.put("ACVoltageBC", !r.getCellText(11).toString().equals("") ? r.getCellText(11).toString() : "0.001");
		rowItem.put("ACVoltageCA", !r.getCellText(12).toString().equals("") ? r.getCellText(12).toString() : "0.001");
		rowItem.put("ACVoltageAN", !r.getCellText(13).toString().equals("") ? r.getCellText(13).toString() : "0.001");
		rowItem.put("ACVoltageBN", !r.getCellText(14).toString().equals("") ? r.getCellText(14).toString() : "0.001");
		rowItem.put("ACVoltageCN", !r.getCellText(15).toString().equals("") ? r.getCellText(15).toString() : "0.001");
		rowItem.put("ActivePower", !r.getCellText(16).toString().equals("") ? r.getCellText(16).toString() : "0.001");
		rowItem.put("Frequency", !r.getCellText(17).toString().equals("") ? r.getCellText(17).toString() : "0.001");
		rowItem.put("ApparentPower", !r.getCellText(18).toString().equals("") ? r.getCellText(18).toString() : "0.001");
		rowItem.put("ReactivePower", !r.getCellText(19).toString().equals("") ? r.getCellText(19).toString() : "0.001");
		rowItem.put("PowerFactor", !r.getCellText(20).toString().equals("") ? r.getCellText(20).toString() : "0.001");
		rowItem.put("ActiveEnergyRawNet", !r.getCellText(21).toString().equals("") ? r.getCellText(21).toString() : "0.001");
		rowItem.put("DCVoltage", !r.getCellText(22).toString().equals("") ? r.getCellText(22).toString() : "0.001");
		rowItem.put("OperatingState", !r.getCellText(23).toString().equals("") ? r.getCellText(23).toString() : "0.001");
		rowItem.put("OperatingStatus", !r.getCellText(24).toString().equals("") ? r.getCellText(24).toString() : "0.001");
		rowItem.put("FaultStatus", !r.getCellText(25).toString().equals("") ? r.getCellText(25).toString() : "0.001");
		rowItem.put("Fault1", !r.getCellText(26).toString().equals("") ? r.getCellText(26).toString() : "0.001");
		rowItem.put("Fault2", !r.getCellText(27).toString().equals("") ? r.getCellText(27).toString() : "0.001");
		rowItem.put("Fault3", !r.getCellText(28).toString().equals("") ? r.getCellText(28).toString() : "0.001");
		rowItem.put("SerialNumberHex4Reg", !r.getCellText(29).toString().equals("") ? r.getCellText(29).toString() : "0.001");
		rowItem.put("CabinetTemperature", !r.getCellText(30).toString().equals("") ? r.getCellText(30).toString() : "0.001");
		rowItem.put("InternalTemperature", !r.getCellText(31).toString().equals("") ? r.getCellText(31).toString() : "0.001");
		rowItem.put("IMITemperature", !r.getCellText(32).toString().equals("") ? r.getCellText(32).toString() : "0.001");
		rowItem.put("ControlDeviceOnOff", !r.getCellText(33).toString().equals("") ? r.getCellText(33).toString() : "0.001");
		rowItem.put("ActivePowerSetpointPercent", !r.getCellText(34).toString().equals("") ? r.getCellText(34).toString() : "0.001");
		rowItem.put("ActivePowerControlEnable", !r.getCellText(35).toString().equals("") ? r.getCellText(35).toString() : "0.001");
		rowItem.put("PowerFactorSetpoint", !r.getCellText(36).toString().equals("") ? r.getCellText(36).toString() : "0.001");
		rowItem.put("PowerFactorControlEnable", !r.getCellText(37).toString().equals("") ? r.getCellText(37).toString() : "0.001");
		rowItem.put("ReactivePowerSetpointPercent", !r.getCellText(38).toString().equals("") ? r.getCellText(38).toString() : "0.001");
		rowItem.put("ReactivePowerControlEnable", !r.getCellText(39).toString().equals("") ? r.getCellText(39).toString() : "0.001");
	...
	public Object setModelElkorProductionMeterv1(HashMap<String, String> rowItem, Row r) {
		rowItem.put("ActivePowerTotal", !r.getCellText(6).toString().equals("") ? r.getCellText(6).toString(): "0.001");
		rowItem.put("ReactivePowerTotal", !r.getCellText(7).toString().equals("") ? r.getCellText(7).toString(): "0.001");
		rowItem.put("ApparentPowerTotal", !r.getCellText(8).toString().equals("") ? r.getCellText(8).toString(): "0.001");
		rowItem.put("VoltageAverage", !r.getCellText(9).toString().equals("") ? r.getCellText(9).toString(): "0.001");
	...
	public Object setModelDent48pshdMeter(HashMap<String, String> rowItem, Row r) {
		rowItem.put("CurrentSum", !r.getCellText(6).toString().equals("") ? r.getCellText(6).toString() : "0.001");
		rowItem.put("CurrentCH1A", !r.getCellText(7).toString().equals("") ? r.getCellText(7).toString() : "0.001");
		rowItem.put("CurrentCH2B", !r.getCellText(8).toString().equals("") ? r.getCellText(8).toString() : "0.001");
		rowItem.put("CurrentCH3C", !r.getCellText(9).toString().equals("") ? r.getCellText(9).toString() : "0.001");
		rowItem.put("VoltageLNAvg", !r.getCellText(10).toString().equals("") ? r.getCellText(10).toString() : "0.001");
		rowItem.put("VoltageL1NAN", !r.getCellText(11).toString().equals("") ? r.getCellText(11).toString() : "0.001");
		rowItem.put("VoltageL2NBN", !r.getCellText(12).toString().equals("") ? r.getCellText(12).toString() : "0.001");
		rowItem.put("VoltageL3NCN", !r.getCellText(13).toString().equals("") ? r.getCellText(13).toString() : "0.001");
		rowItem.put("VoltageLLAvg", !r.getCellText(14).toString().equals("") ? r.getCellText(14).toString() : "0.001");
		rowItem.put("VoltageL1L2", !r.getCellText(15).toString().equals("") ? r.getCellText(15).toString() : "0.001");
		rowItem.put("VoltageL2L3", !r.getCellText(16).toString().equals("") ? r.getCellText(16).toString() : "0.001");
		rowItem.put("VoltageL3L1", !r.getCellText(17).toString().equals("") ? r.getCellText(17).toString() : "0.001");
		rowItem.put("LineFrequency", !r.getCellText(18).toString().equals("") ? r.getCellText(18).toString() : "0.001");
		rowItem.put("PowerSum", !r.getCellText(19).toString().equals("") ? r.getCellText(19).toString() : "0.001");
		rowItem.put("PowerCH1A", !r.getCellText(20).toString().equals("") ? r.getCellText(20).toString() : "0.001");
		rowItem.put("PowerCH2B", !r.getCellText(21).toString().equals("") ? r.getCellText(21).toString() : "0.001");
		rowItem.put("PowerCH3C", !r.getCellText(22).toString().equals("") ? r.getCellText(22).toString() : "0.001");
		rowItem.put("VASum", !r.getCellText(23).toString().equals("") ? r.getCellText(23).toString() : "0.001");
		rowItem.put("VACH1A", !r.getCellText(24).toString().equals("") ? r.getCellText(24).toString() : "0.001");
		rowItem.put("VACH2B", !r.getCellText(25).toString().equals("") ? r.getCellText(25).toString() : "0.001");
		rowItem.put("VACH3C", !r.getCellText(26).toString().equals("") ? r.getCellText(26).toString() : "0.001");
		rowItem.put("VARSum", !r.getCellText(27).toString().equals("") ? r.getCellText(27).toString() : "0.001");
		rowItem.put("VARCH1A", !r.getCellText(28).toString().equals("") ? r.getCellText(28).toString() : "0.001");
		rowItem.put("VARCH2B", !r.getCellText(29).toString().equals("") ? r.getCellText(29).toString() : "0.001");
		rowItem.put("VARCH3C", !r.getCellText(30).toString().equals("") ? r.getCellText(30).toString() : "0.001");
		rowItem.put("ApparentPFAvg", !r.getCellText(31).toString().equals("") ? r.getCellText(31).toString() : "0.001");
		rowItem.put("ApparentPFCH1A", !r.getCellText(32).toString().equals("") ? r.getCellText(32).toString() : "0.001");
		rowItem.put("ApparentPFCH2B", !r.getCellText(33).toString().equals("") ? r.getCellText(33).toString() : "0.001");
		rowItem.put("ApparentPFCH3C", !r.getCellText(34).toString().equals("") ? r.getCellText(34).toString() : "0.001");
		rowItem.put("ExportedEnergySum", !r.getCellText(35).toString().equals("") ? r.getCellText(35).toString() : "0.001");
		rowItem.put("ExportedEnergyCH1A", !r.getCellText(36).toString().equals("") ? r.getCellText(36).toString() : "0.001");
		rowItem.put("ExportedEnergyCH2B", !r.getCellText(37).toString().equals("") ? r.getCellText(37).toString() : "0.001");
		rowItem.put("ExportedEnergyCH3C", !r.getCellText(38).toString().equals("") ? r.getCellText(38).toString() : "0.001");
		rowItem.put("ImportedEnergySum", !r.getCellText(39).toString().equals("") ? r.getCellText(39).toString() : "0.001");
		rowItem.put("ImportedEnergyCH1A", !r.getCellText(40).toString().equals("") ? r.getCellText(40).toString() : "0.001");
		rowItem.put("ImportedEnergyCH2B", !r.getCellText(41).toString().equals("") ? r.getCellText(41).toString() : "0.001");
		rowItem.put("ImportedEnergyCH3C", !r.getCellText(42).toString().equals("") ? r.getCellText(42).toString() : "0.001");
		rowItem.put("ExportedVAhSum", !r.getCellText(43).toString().equals("") ? r.getCellText(43).toString() : "0.001");
		rowItem.put("ExportedVAhCH1A", !r.getCellText(44).toString().equals("") ? r.getCellText(44).toString() : "0.001");
		rowItem.put("ExportedVAhCH2B", !r.getCellText(45).toString().equals("") ? r.getCellText(45).toString() : "0.001");
		rowItem.put("ExportedVAhCH3C", !r.getCellText(46).toString().equals("") ? r.getCellText(46).toString() : "0.001");
		rowItem.put("ImportedVAhSum", !r.getCellText(47).toString().equals("") ? r.getCellText(47).toString() : "0.001");
		rowItem.put("ImportedVAhCH1A", !r.getCellText(48).toString().equals("") ? r.getCellText(48).toString() : "0.001");
		rowItem.put("ImportedVAhCH2B", r.getCellText(49).toString().equals("") ? r.getCellText(49).toString() : "0.001");
		rowItem.put("ImportedVAhCH3C", !r.getCellText(50).toString().equals("") ? r.getCellText(50).toString() : "0.001");
		rowItem.put("ImportedVARhQ1Sum", !r.getCellText(51).toString().equals("") ? r.getCellText(51).toString() : "0.001");
		rowItem.put("ImportedVARhQ1A", !r.getCellText(52).toString().equals("") ? r.getCellText(52).toString() : "0.001");
		rowItem.put("ImportedVARhQ1B", !r.getCellText(53).toString().equals("") ? r.getCellText(53).toString() : "0.001");
		rowItem.put("ImportedVARhQ1C", !r.getCellText(54).toString().equals("") ? r.getCellText(54).toString() : "0.001");
		rowItem.put("ImportedVARhQ2Sum", !r.getCellText(55).toString().equals("") ? r.getCellText(55).toString() : "0.001");
		rowItem.put("ImportedVARhQ2A", !r.getCellText(56).toString().equals("") ? r.getCellText(56).toString() : "0.001");
		rowItem.put("ImportedVARhQ2B", !r.getCellText(57).toString().equals("") ? r.getCellText(57).toString() : "0.001");
		rowItem.put("ImportedVARhQ2C", !r.getCellText(58).toString().equals("") ? r.getCellText(58).toString() : "0.001");
		rowItem.put("ExportedVARhQ3Sum", !r.getCellText(59).toString().equals("") ? r.getCellText(59).toString() : "0.001");
		rowItem.put("ExportedVARhQ3A", !r.getCellText(60).toString().equals("") ? r.getCellText(60).toString() : "0.001");
		rowItem.put("ExportedVARhQ3B", !r.getCellText(61).toString().equals("") ? r.getCellText(61).toString() : "0.001");
		rowItem.put("ExportedVARhQ3C", !r.getCellText(62).toString().equals("") ? r.getCellText(62).toString() : "0.001");
		rowItem.put("ExportedVARhQ4Sum", !r.getCellText(63).toString().equals("") ? r.getCellText(63).toString() : "0.001");
		rowItem.put("ExportedVARhQ4A", !r.getCellText(64).toString().equals("") ? r.getCellText(64).toString() : "0.001");
		rowItem.put("ExportedVARhQ4B", !r.getCellText(65).toString().equals("") ? r.getCellText(65).toString() : "0.001");
		rowItem.put("ExportedVARhQ4C", !r.getCellText(66).toString().equals("") ? r.getCellText(66).toString() : "0.001");
		rowItem.put("WattDemandElement", !r.getCellText(67).toString().equals("") ? r.getCellText(67).toString() : "0.001");
		
//		rowItem.put("DisplacementPFSum", !r.getCellText(68).toString().equals("") ? r.getCellText(68).toString() : "0.001");
//		rowItem.put("DisplacementPFCH1A", !r.getCellText(69).toString().equals("") ? r.getCellText(69).toString() : "0.001");
//		rowItem.put("DisplacementPFCH2B", !r.getCellText(70).toString().equals("") ? r.getCellText(70).toString() : "0.001");
//		rowItem.put("DisplacementPFCH3C", !r.getCellText(71).toString().equals("") ? r.getCellText(71).toString() : "0.001");
//		rowItem.put("THDSum", !r.getCellText(72).toString().equals("") ? r.getCellText(72).toString() : "0.001");
//		rowItem.put("THDCH1A", !r.getCellText(73).toString().equals("") ? r.getCellText(73).toString() : "0.001");
//		rowItem.put("THDCH2B", !r.getCellText(74).toString().equals("") ? r.getCellText(74).toString() : "0.001");
//		rowItem.put("THDCH3C", !r.getCellText(75).toString().equals("") ? r.getCellText(75).toString() : "0.001");
//		rowItem.put("VADemandElement", !r.getCellText(76).toString().equals("") ? r.getCellText(76).toString() : "0.001");
//		rowItem.put("EnergyNetSum", !r.getCellText(77).toString().equals("") ? r.getCellText(77).toString() : "0.001");
//		rowItem.put("EnergyNetCH1", !r.getCellText(78).toString().equals("") ? r.getCellText(78).toString() : "0.001");
//		rowItem.put("EnergyNetCH2", !r.getCellText(79).toString().equals("") ? r.getCellText(79).toString() : "0.001");
//		rowItem.put("EnergyNetCH3", !r.getCellText(80).toString().equals("") ? r.getCellText(80).toString() : "0.001");
//		rowItem.put("ApparentEnergyNetSum", !r.getCellText(81).toString().equals("") ? r.getCellText(81).toString() : "0.001");
//		rowItem.put("ApparentEnergyNetCH1", !r.getCellText(82).toString().equals("") ? r.getCellText(82).toString() : "0.001");
//		rowItem.put("ApparentEnergyNetCH2", !r.getCellText(83).toString().equals("") ? r.getCellText(83).toString() : "0.001");
//		rowItem.put("ApparentEnergyNetCH3", !r.getCellText(84).toString().equals("") ? r.getCellText(84).toString() : "0.001");
//		rowItem.put("VARhNetSum", !r.getCellText(85).toString().equals("") ? r.getCellText(85).toString() : "0.001");
//		rowItem.put("VARhNetCH1", !r.getCellText(86).toString().equals("") ? r.getCellText(86).toString() : "0.001");
//		rowItem.put("VARhNetCH2", !r.getCellText(87).toString().equals("") ? r.getCellText(87).toString() : "0.001");
//		rowItem.put("VARhNetCH3", !r.getCellText(88).toString().equals("") ? r.getCellText(88).toString() : "0.001");
//		rowItem.put("ThetaCH1Angle", !r.getCellText(89).toString().equals("") ? r.getCellText(89).toString() : "0.001");
//		rowItem.put("ThetaCH2Angle", !r.getCellText(90).toString().equals("") ? r.getCellText(90).toString() : "0.001");
//		rowItem.put("ThetaCH3Angle", !r.getCellText(91).toString().equals("") ? r.getCellText(91).toString() : "0.001");
//		rowItem.put("RoCoilPGAGainCh1", !r.getCellText(92).toString().equals("") ? r.getCellText(92).toString() : "0.001");
//		rowItem.put("RoCoilPGAGainCh2", !r.getCellText(93).toString().equals("") ? r.getCellText(93).toString() : "0.001");
//		rowItem.put("RoCoilPGAGainCh3", !r.getCellText(94).toString().equals("") ? r.getCellText(94).toString() : "0.001");		
		rowItem.put("nvmActivePower", !r.getCellText(68).toString().equals("") ? r.getCellText(68).toString() : "0.001");
		rowItem.put("nvmActiveEnergy", !r.getCellText(69).toString().equals("") ? r.getCellText(69).toString() : "0.001");
		rowItem.put("MeasuredProduction", !r.getCellText(70).toString().equals("") ? r.getCellText(70).toString() : "0.001");
	...
	public Object setModelSolaredgeInverterV1(HashMap<String, String> rowItem, Row r) {		
		rowItem.put("C_DeviceAddress", !r.getCellText(6).toString().equals("") ? r.getCellText(6).toString() : "0.001");
		rowItem.put("C_SunSpec_DID", !r.getCellText(7).toString().equals("") ? r.getCellText(7).toString() : "0.001");
		rowItem.put("C_SunSpec_Length", !r.getCellText(8).toString().equals("") ? r.getCellText(8).toString() : "0.001");
		rowItem.put("I_AC_Current", !r.getCellText(9).toString().equals("") ? r.getCellText(9).toString() : "0.001");
		...
		rowItem.put("I_Status", !r.getCellText(41).toString().equals("") ? r.getCellText(41).toString() : "0.001");
		rowItem.put("I_Status_Vendor", !r.getCellText(42).toString().equals("") ? r.getCellText(42).toString() : "0.001");
		rowItem.put("Serial_Number_Hex_4_Reg", !r.getCellText(43).toString().equals("") ? r.getCellText(43).toString() : "0.001");
		rowItem.put("nvmActivePower", !r.getCellText(44).toString().equals("") ? r.getCellText(44).toString() : "0.001");
		rowItem.put("nvmActiveEnergy", !r.getCellText(45).toString().equals("") ? r.getCellText(45).toString() : "0.001");
		rowItem.put("MeasuredProduction", !r.getCellText(46).toString().equals("") ? r.getCellText(46).toString() : "0.001");
		return rowItem;
	}
	...
	public Object setModelPowerLogicPM8000LoadMeter(HashMap<String, String> rowItem, Row r) {
		rowItem.put("ActiveEnergyDelivered", !r.getCellText(6).toString().equals("") ? r.getCellText(6).toString() : "0.001");
		rowItem.put("ActiveEnergyReceived", !r.getCellText(7).toString().equals("") ? r.getCellText(7).toString() : "0.001");
		rowItem.put("ActiveEnergyDeliveredPlusReceived", !r.getCellText(8).toString().equals("") ? r.getCellText(8).toString() : "0.001");
		rowItem.put("ActiveEnergyDeliveredMinusReceived", !r.getCellText(9).toString().equals("") ? r.getCellText(9).toString() : "0.001");
		rowItem.put("ReactiveEnergyDelivered", !r.getCellText(10).toString().equals("") ? r.getCellText(10).toString() : "0.001");
		rowItem.put("ReactiveEnergyReceived", !r.getCellText(11).toString().equals("") ? r.getCellText(11).toString() : "0.001");
		rowItem.put("ReactiveEnergyDeliveredPlusReceived", !r.getCellText(12).toString().equals("") ? r.getCellText(12).toString() : "0.001");
		rowItem.put("ReactiveEnergyDeliveredMinusReceived", !r.getCellText(13).toString().equals("") ? r.getCellText(13).toString() : "0.001");
		rowItem.put("ApparentEnergyDelivered", !r.getCellText(14).toString().equals("") ? r.getCellText(14).toString() : "0.001");
		rowItem.put("ApparentEnergyReceived", !r.getCellText(15).toString().equals("") ? r.getCellText(15).toString() : "0.001");
		rowItem.put("ApparentEnergyDeliveredPlusReceived", !r.getCellText(16).toString().equals("") ? r.getCellText(16).toString() : "0.001");
		rowItem.put("ApparentEnergyDeliveredMinusReceived", !r.getCellText(17).toString().equals("") ? r.getCellText(17).toString() : "0.001");
		rowItem.put("ActiveEnergyinQuadrantI", !r.getCellText(18).toString().equals("") ? r.getCellText(18).toString() : "0.001");
		rowItem.put("ActiveEnergyinQuadrantII", !r.getCellText(19).toString().equals("") ? r.getCellText(19).toString() : "0.001");
		rowItem.put("ActiveEnergyinQuadrantIII", !r.getCellText(20).toString().equals("") ? r.getCellText(20).toString() : "0.001");
		rowItem.put("ActiveEnergyinQuadrantIV", !r.getCellText(21).toString().equals("") ? r.getCellText(21).toString() : "0.001");
		rowItem.put("ReactiveEnergyinQuadrantI", !r.getCellText(22).toString().equals("") ? r.getCellText(22).toString() : "0.001");
		rowItem.put("ReactiveEnergyinQuadrantII", !r.getCellText(23).toString().equals("") ? r.getCellText(23).toString() : "0.001");
		rowItem.put("ReactiveEnergyinQuadrantIII", !r.getCellText(24).toString().equals("") ? r.getCellText(24).toString() : "0.001");
		rowItem.put("ReactiveEnergyinQuadrantIV", !r.getCellText(25).toString().equals("") ? r.getCellText(25).toString() : "0.001");
		rowItem.put("ApparentEnergyinQuadrantI", !r.getCellText(26).toString().equals("") ? r.getCellText(26).toString() : "0.001");
		rowItem.put("ApparentEnergyinQuadrantII", !r.getCellText(27).toString().equals("") ? r.getCellText(27).toString() : "0.001");
		rowItem.put("ApparentEnergyinQuadrantIII", !r.getCellText(28).toString().equals("") ? r.getCellText(28).toString() : "0.001");
		rowItem.put("ApparentEnergyinQuadrantIV", !r.getCellText(29).toString().equals("") ? r.getCellText(29).toString() : "0.001");
		rowItem.put("CurrentPhaseA", !r.getCellText(30).toString().equals("") ? r.getCellText(30).toString() : "0.001");
		rowItem.put("CurrentPhaseB", !r.getCellText(31).toString().equals("") ? r.getCellText(31).toString() : "0.001");
		rowItem.put("CurrentPhaseC", !r.getCellText(32).toString().equals("") ? r.getCellText(32).toString() : "0.001");
		rowItem.put("CurrentNeutralLine", !r.getCellText(33).toString().equals("") ? r.getCellText(33).toString() : "0.001");
		rowItem.put("CurrentGroundLine", !r.getCellText(34).toString().equals("") ? r.getCellText(34).toString() : "0.001");
		rowItem.put("CurrentAverage", !r.getCellText(35).toString().equals("") ? r.getCellText(35).toString() : "0.001");
		rowItem.put("CurrentUnbalanceWorst", !r.getCellText(36).toString().equals("") ? r.getCellText(36).toString() : "0.001");
		rowItem.put("VoltagePhaseAB", !r.getCellText(37).toString().equals("") ? r.getCellText(37).toString() : "0.001");
		rowItem.put("VoltagePhaseBC", !r.getCellText(38).toString().equals("") ? r.getCellText(38).toString() : "0.001");
		rowItem.put("VoltagePhaseCA", !r.getCellText(39).toString().equals("") ? r.getCellText(39).toString() : "0.001");
		rowItem.put("VoltageLLAverage", !r.getCellText(40).toString().equals("") ? r.getCellText(40).toString() : "0.001");
		rowItem.put("VoltageAN", !r.getCellText(41).toString().equals("") ? r.getCellText(41).toString() : "0.001");
		rowItem.put("VoltageBN", !r.getCellText(42).toString().equals("") ? r.getCellText(42).toString() : "0.001");
		rowItem.put("VoltageCN", !r.getCellText(43).toString().equals("") ? r.getCellText(43).toString() : "0.001");
		rowItem.put("VoltageLNAverage", !r.getCellText(44).toString().equals("") ? r.getCellText(44).toString() : "0.001");
		rowItem.put("VoltageUnbalanceLNWorst", !r.getCellText(45).toString().equals("") ? r.getCellText(45).toString() : "0.001");
		rowItem.put("ActivePowerPhaseA", !r.getCellText(46).toString().equals("") ? r.getCellText(46).toString() : "0.001");
		rowItem.put("ActivePowerPhaseB", !r.getCellText(47).toString().equals("") ? r.getCellText(47).toString() : "0.001");
		rowItem.put("ActivePowerPhaseC", !r.getCellText(48).toString().equals("") ? r.getCellText(48).toString() : "0.001");
		rowItem.put("ActivePowerTotal", !r.getCellText(49).toString().equals("") ? r.getCellText(49).toString() : "0.001");
		rowItem.put("ReactivePowerPhaseA", !r.getCellText(50).toString().equals("") ? r.getCellText(50).toString() : "0.001");
		rowItem.put("ReactivePowerPhaseB", !r.getCellText(51).toString().equals("") ? r.getCellText(51).toString() : "0.001");
		rowItem.put("ReactivePowerPhaseC", !r.getCellText(52).toString().equals("") ? r.getCellText(52).toString() : "0.001");
		rowItem.put("ReactivePowerTotal", !r.getCellText(53).toString().equals("") ? r.getCellText(53).toString() : "0.001");
		rowItem.put("ApparentPowerPhaseA", !r.getCellText(54).toString().equals("") ? r.getCellText(54).toString() : "0.001");
		rowItem.put("ApparentPowerPhaseB", !r.getCellText(55).toString().equals("") ? r.getCellText(55).toString() : "0.001");
		rowItem.put("ApparentPowerPhaseC", !r.getCellText(56).toString().equals("") ? r.getCellText(56).toString() : "0.001");
		rowItem.put("ApparentPowerTotal", !r.getCellText(57).toString().equals("") ? r.getCellText(57).toString() : "0.001");
		rowItem.put("Frequency", !r.getCellText(58).toString().equals("") ? r.getCellText(58).toString() : "0.001");
		rowItem.put("PowerFactorPhaseA", !r.getCellText(59).toString().equals("") ? r.getCellText(59).toString() : "0.001");
		rowItem.put("PowerFactorPhaseB", !r.getCellText(60).toString().equals("") ? r.getCellText(60).toString() : "0.001");
		rowItem.put("PowerFactorPhaseC", !r.getCellText(61).toString().equals("") ? r.getCellText(61).toString() : "0.001");
		rowItem.put("PowerFactorTotal", !r.getCellText(62).toString().equals("") ? r.getCellText(62).toString() : "0.001");
		
		return rowItem;
	}
	
	public Object setModelHoneywellEMON3200(HashMap<String, String> rowItem, Row r) {
		rowItem.put("AuxilaryPulseInput1", !r.getCellText(6).toString().equals("") ? r.getCellText(6).toString() : "0.001");
		rowItem.put("AuxilaryPulseInput2", !r.getCellText(7).toString().equals("") ? r.getCellText(7).toString() : "0.001");
		rowItem.put("EnergyDelivered", !r.getCellText(8).toString().equals("") ? r.getCellText(8).toString() : "0.001");
		rowItem.put("EnergyReceived", !r.getCellText(9).toString().equals("") ? r.getCellText(9).toString() : "0.001");
		rowItem.put("ReactiveEnergyDelivered", !r.getCellText(10).toString().equals("") ? r.getCellText(10).toString() : "0.001");
		rowItem.put("ReactiveEnergyReceived", !r.getCellText(11).toString().equals("") ? r.getCellText(11).toString() : "0.001");
		rowItem.put("RealPower", !r.getCellText(12).toString().equals("") ? r.getCellText(12).toString() : "0.001");
		rowItem.put("ReactivePower", !r.getCellText(13).toString().equals("") ? r.getCellText(13).toString() : "0.001");
		rowItem.put("ApparentPower", !r.getCellText(14).toString().equals("") ? r.getCellText(14).toString() : "0.001");
		rowItem.put("PowerFactor", !r.getCellText(15).toString().equals("") ? r.getCellText(15).toString() : "0.001");
		rowItem.put("CurrentTotal", !r.getCellText(16).toString().equals("") ? r.getCellText(16).toString() : "0.001");
		rowItem.put("CurrentAverage", !r.getCellText(17).toString().equals("") ? r.getCellText(17).toString() : "0.001");
		rowItem.put("VoltageLineNeutral", !r.getCellText(18).toString().equals("") ? r.getCellText(18).toString() : "0.001");
		rowItem.put("VoltageLineLine", !r.getCellText(19).toString().equals("") ? r.getCellText(19).toString() : "0.001");
		rowItem.put("Frequency", !r.getCellText(20).toString().equals("") ? r.getCellText(20).toString() : "0.001");
		rowItem.put("PhaseAngle", !r.getCellText(21).toString().equals("") ? r.getCellText(21).toString() : "0.001");
		rowItem.put("RealPowerPhaseA", !r.getCellText(22).toString().equals("") ? r.getCellText(22).toString() : "0.001");
		rowItem.put("RealPowerPhaseB", !r.getCellText(23).toString().equals("") ? r.getCellText(23).toString() : "0.001");
		rowItem.put("RealPowerPhaseC", !r.getCellText(24).toString().equals("") ? r.getCellText(24).toString() : "0.001");
		rowItem.put("ReactivePowerPhaseA", !r.getCellText(25).toString().equals("") ? r.getCellText(25).toString() : "0.001");
		rowItem.put("ReactivePowerPhaseB", !r.getCellText(26).toString().equals("") ? r.getCellText(26).toString() : "0.001");
		rowItem.put("ReactivePowerPhaseC", !r.getCellText(27).toString().equals("") ? r.getCellText(27).toString() : "0.001");
		rowItem.put("ApparentPowerPhaseA", !r.getCellText(28).toString().equals("") ? r.getCellText(28).toString() : "0.001");
		rowItem.put("ApparentPowerPhaseB", !r.getCellText(29).toString().equals("") ? r.getCellText(29).toString() : "0.001");
		rowItem.put("ApparentPowerPhaseC", !r.getCellText(30).toString().equals("") ? r.getCellText(30).toString() : "0.001");
		rowItem.put("PowerFactorPhaseA", !r.getCellText(31).toString().equals("") ? r.getCellText(31).toString() : "0.001");
		rowItem.put("PowerFactorPhaseB", !r.getCellText(32).toString().equals("") ? r.getCellText(32).toString() : "0.001");
		rowItem.put("PowerFactorPhaseC", !r.getCellText(33).toString().equals("") ? r.getCellText(33).toString() : "0.001");
		rowItem.put("CurrentPhaseA", !r.getCellText(34).toString().equals("") ? r.getCellText(34).toString() : "0.001");
		rowItem.put("CurrentPhaseB", !r.getCellText(35).toString().equals("") ? r.getCellText(35).toString() : "0.001");
		rowItem.put("CurrentPhaseC", !r.getCellText(36).toString().equals("") ? r.getCellText(36).toString() : "0.001");
		rowItem.put("VoltagePhaseAN", !r.getCellText(37).toString().equals("") ? r.getCellText(37).toString() : "0.001");
		rowItem.put("VoltagePhaseBN", !r.getCellText(38).toString().equals("") ? r.getCellText(38).toString() : "0.001");
		rowItem.put("VoltagePhaseCN", !r.getCellText(39).toString().equals("") ? r.getCellText(39).toString() : "0.001");
		rowItem.put("VoltagePhaseAB", !r.getCellText(40).toString().equals("") ? r.getCellText(40).toString() : "0.001");
		rowItem.put("VoltagePhaseBC", !r.getCellText(41).toString().equals("") ? r.getCellText(41).toString() : "0.001");
		rowItem.put("VoltagePhaseCA", !r.getCellText(42).toString().equals("") ? r.getCellText(42).toString() : "0.001");
		rowItem.put("PhaseAngleA", !r.getCellText(43).toString().equals("") ? r.getCellText(43).toString() : "0.001");
		rowItem.put("PhaseAngleB", !r.getCellText(44).toString().equals("") ? r.getCellText(44).toString() : "0.001");
		rowItem.put("PhaseAngleC", !r.getCellText(45).toString().equals("") ? r.getCellText(45).toString() : "0.001");
	...
	public Object setModelQUINT4UPS(HashMap<String, String> rowItem, Row r) {
		rowItem.put("ActualInputVoltage", !r.getCellText(6).toString().equals("") ? r.getCellText(6).toString() : "0.001");
		rowItem.put("ActualInputCurrent", !r.getCellText(7).toString().equals("") ? r.getCellText(7).toString() : "0.001");
		rowItem.put("ActualOutputVoltage", !r.getCellText(8).toString().equals("") ? r.getCellText(8).toString() : "0.001");
		rowItem.put("ActualOutputCurrent", !r.getCellText(9).toString().equals("") ? r.getCellText(9).toString() : "0.001");
		...
		rowItem.put("StateofCharge", !r.getCellText(14).toString().equals("") ? r.getCellText(14).toString() : "0.001");
		rowItem.put("StateofChargeRemainingTime", !r.getCellText(15).toString().equals("") ? r.getCellText(15).toString() : "0.001");
		rowItem.put("StateofHealth", !r.getCellText(16).toString().equals("") ? r.getCellText(16).toString() : "0.001");
		rowItem.put("StateofHealthRemainingLifetime", !r.getCellText(17).toString().equals("") ? r.getCellText(17).toString() : "0.001");
		rowItem.put("OperationTime", !r.getCellText(18).toString().equals("") ? r.getCellText(18).toString() : "0.001");
		rowItem.put("BatteryModeTime", !r.getCellText(19).toString().equals("") ? r.getCellText(19).toString() : "0.001");
		rowItem.put("StatusAlarm", !r.getCellText(20).toString().equals("") ? r.getCellText(20).toString() : "0.001");
		rowItem.put("StatusWarning", !r.getCellText(21).toString().equals("") ? r.getCellText(21).toString() : "0.001");
		rowItem.put("Battery1StateofCharge", !r.getCellText(22).toString().equals("") ? r.getCellText(22).toString() : "0.001");
		rowItem.put("Battery1StateofHealth", !r.getCellText(23).toString().equals("") ? r.getCellText(23).toString() : "0.001");
		rowItem.put("Battery1Temperature", !r.getCellText(24).toString().equals("") ? r.getCellText(24).toString() : "0.001");
		rowItem.put("Battery1StatusofFuse", !r.getCellText(25).toString().equals("") ? r.getCellText(25).toString() : "0.001");
		rowItem.put("Battery1ActualInternalVoltage", !r.getCellText(26).toString().equals("") ? r.getCellText(26).toString() : "0.001");
		rowItem.put("Battery1ActualBlockVoltage", !r.getCellText(27).toString().equals("") ? r.getCellText(27).toString() : "0.001");
		rowItem.put("Battery1InstalledCapacity", !r.getCellText(28).toString().equals("") ? r.getCellText(28).toString() : "0.001");
		rowItem.put("Battery1NominalResistance", !r.getCellText(29).toString().equals("") ? r.getCellText(29).toString() : "0.001");
		rowItem.put("Battery1MaxTemperature", !r.getCellText(30).toString().equals("") ? r.getCellText(30).toString() : "0.001");
		rowItem.put("Battery1MinTemperature", !r.getCellText(31).toString().equals("") ? r.getCellText(31).toString() : "0.001");
		rowItem.put("Battery1NominalLifetime", !r.getCellText(32).toString().equals("") ? r.getCellText(32).toString() : "0.001");
		rowItem.put("Battery1MaxChargeCurrent", !r.getCellText(33).toString().equals("") ? r.getCellText(33).toString() : "0.001");
		rowItem.put("Battery1ChargeAbsorptionVoltage", !r.getCellText(34).toString().equals("") ? r.getCellText(34).toString() : "0.001");
		rowItem.put("Battery1ChargeEndvoltage", !r.getCellText(35).toString().equals("") ? r.getCellText(35).toString() : "0.001");
		rowItem.put("Battery1ChargeTemperatureCoefficient", !r.getCellText(36).toString().equals("") ? r.getCellText(36).toString() : "0.001");
		rowItem.put("Battery1DischargeEndvoltage", !r.getCellText(37).toString().equals("") ? r.getCellText(37).toString() : "0.001");
		rowItem.put("Battery1MaxDischargeCurrent", !r.getCellText(38).toString().equals("") ? r.getCellText(38).toString() : "0.001");
		rowItem.put("Battery1MaxTemperatureWarning", !r.getCellText(39).toString().equals("") ? r.getCellText(39).toString() : "0.001");
		rowItem.put("Battery1MinTemperatureWarning", !r.getCellText(40).toString().equals("") ? r.getCellText(40).toString() : "0.001");
		rowItem.put("Battery1DischargeEndvoltageLowCurrent", !r.getCellText(41).toString().equals("") ? r.getCellText(41).toString() : "0.001");
		
		return rowItem;
	}
	
	
	public Object setModelHuaweiSun200028ktl(HashMap<String, String> rowItem, Row r) {
		rowItem.put("ActivePower", !r.getCellText(6).toString().equals("") ? r.getCellText(6).toString() : "0.001");
		rowItem.put("ReactivePower", !r.getCellText(7).toString().equals("") ? r.getCellText(7).toString() : "0.001");
		rowItem.put("TotalDCInputCurrent", !r.getCellText(8).toString().equals("") ? r.getCellText(8).toString() : "0.001");
		rowItem.put("TotalInputPower", !r.getCellText(9).toString().equals("") ? r.getCellText(9).toString() : "0.001");
		rowItem.put("InsulationResistance", !r.getCellText(10).toString().equals("") ? r.getCellText(10).toString() : "0.001");
		rowItem.put("PowerFactor", !r.getCellText(11).toString().equals("") ? r.getCellText(11).toString() : "0.001");
		rowItem.put("InverterStatus", !r.getCellText(12).toString().equals("") ? r.getCellText(12).toString() : "0.001");
		rowItem.put("CabinetTemperature", !r.getCellText(13).toString().equals("") ? r.getCellText(13).toString() : "0.001");
		rowItem.put("MajorFaultCode", !r.getCellText(14).toString().equals("") ? r.getCellText(14).toString() : "0.001");
		rowItem.put("MinorFaultCode", !r.getCellText(15).toString().equals("") ? r.getCellText(15).toString() : "0.001");
		rowItem.put("WarningCode", !r.getCellText(16).toString().equals("") ? r.getCellText(16).toString() : "0.001");
		rowItem.put("nvmActivePower", !r.getCellText(17).toString().equals("") ? r.getCellText(17).toString() : "0.001");
		rowItem.put("nvmActiveEnergy", !r.getCellText(18).toString().equals("") ? r.getCellText(18).toString() : "0.001");
		rowItem.put("MeasuredProduction", !r.getCellText(19).toString().equals("") ? r.getCellText(19).toString() : "0.001");
	...
	public Object setModelSmartlogger3000(HashMap<String, String> rowItem, Row r) {
		rowItem.put("PowerOn", !r.getCellText(6).toString().equals("") ? r.getCellText(6).toString() : "0.001");
		rowItem.put("PowerOff", !r.getCellText(7).toString().equals("") ? r.getCellText(7).toString() : "0.001");
		rowItem.put("PowerOnOff", !r.getCellText(8).toString().equals("") ? r.getCellText(8).toString() : "0.001");
		rowItem.put("PowerOnOffReverse", !r.getCellText(9).toString().equals("") ? r.getCellText(9).toString() : "0.001");
		rowItem.put("TransferTrip", !r.getCellText(10).toString().equals("") ? r.getCellText(10).toString() : "0.001");
		rowItem.put("ArrayReset", !r.getCellText(11).toString().equals("") ? r.getCellText(11).toString() : "0.001");
		rowItem.put("ActiveAdjustment", !r.getCellText(12).toString().equals("") ? r.getCellText(12).toString() : "0.001");
		rowItem.put("ReactiveAdjustment", !r.getCellText(13).toString().equals("") ? r.getCellText(13).toString() : "0.001");
		rowItem.put("ActiveAdjustment2", !r.getCellText(14).toString().equals("") ? r.getCellText(14).toString() : "0.001");
		rowItem.put("ReactiveAdjustment2", !r.getCellText(15).toString().equals("") ? r.getCellText(15).toString() : "0.001");
		rowItem.put("ActivePowerAdjustmentBy", !r.getCellText(16).toString().equals("") ? r.getCellText(16).toString() : "0.001");
		rowItem.put("PowerFactorAdjustment", !r.getCellText(17).toString().equals("") ? r.getCellText(17).toString() : "0.001");
		rowItem.put("DCCurrent", !r.getCellText(18).toString().equals("") ? r.getCellText(18).toString() : "0.001");
		rowItem.put("InputPower", !r.getCellText(19).toString().equals("") ? r.getCellText(19).toString() : "0.001");
		rowItem.put("CO2Reduction", !r.getCellText(20).toString().equals("") ? r.getCellText(20).toString() : "0.001");
		rowItem.put("ActivePower", !r.getCellText(21).toString().equals("") ? r.getCellText(21).toString() : "0.001");
		rowItem.put("PowerFactor", !r.getCellText(22).toString().equals("") ? r.getCellText(22).toString() : "0.001");
		rowItem.put("PlantStatusQinghai", !r.getCellText(23).toString().equals("") ? r.getCellText(23).toString() : "0.001");
		rowItem.put("ReactivePower", !r.getCellText(24).toString().equals("") ? r.getCellText(24).toString() : "0.001");
		rowItem.put("CO2ReductionLarge", !r.getCellText(25).toString().equals("") ? r.getCellText(25).toString() : "0.001");
		rowItem.put("DCCurrent2", !r.getCellText(26).toString().equals("") ? r.getCellText(26).toString() : "0.001");
		rowItem.put("ETotal", !r.getCellText(27).toString().equals("") ? r.getCellText(27).toString() : "0.001");
		rowItem.put("EDaily", !r.getCellText(28).toString().equals("") ? r.getCellText(28).toString() : "0.001");
		rowItem.put("DurationOfDailyPowerGeneration", !r.getCellText(29).toString().equals("") ? r.getCellText(29).toString() : "0.001");
		rowItem.put("PlantStatusXinjiang", !r.getCellText(30).toString().equals("") ? r.getCellText(30).toString() : "0.001");
		rowItem.put("PlantStatusNingxia", !r.getCellText(31).toString().equals("") ? r.getCellText(31).toString() : "0.001");
		rowItem.put("ActiveAlarmSequenceNumber", !r.getCellText(32).toString().equals("") ? r.getCellText(32).toString() : "0.001");
		rowItem.put("HistoricalAlarmSequenceNumber", !r.getCellText(33).toString().equals("") ? r.getCellText(33).toString() : "0.001");
		rowItem.put("PhaseACurrent", !r.getCellText(34).toString().equals("") ? r.getCellText(34).toString() : "0.001");
		rowItem.put("PhaseBCurrent", !r.getCellText(35).toString().equals("") ? r.getCellText(35).toString() : "0.001");
		rowItem.put("PhaseCCurrent", !r.getCellText(36).toString().equals("") ? r.getCellText(36).toString() : "0.001");
		rowItem.put("Uab", !r.getCellText(37).toString().equals("") ? r.getCellText(37).toString() : "0.001");
		rowItem.put("Ubc", !r.getCellText(38).toString().equals("") ? r.getCellText(38).toString() : "0.001");
		rowItem.put("Uca", !r.getCellText(39).toString().equals("") ? r.getCellText(39).toString() : "0.001");
		rowItem.put("Reserved", !r.getCellText(40).toString().equals("") ? r.getCellText(40).toString() : "0.001");
		rowItem.put("InverterEfficiency", !r.getCellText(41).toString().equals("") ? r.getCellText(41).toString() : "0.001");
		
		
		rowItem.put("MaxReactiveAdjustment", !r.getCellText(42).toString().equals("") ? r.getCellText(42).toString() : "0.001");
		rowItem.put("MinReactiveAdjustment", !r.getCellText(43).toString().equals("") ? r.getCellText(43).toString() : "0.001");
		rowItem.put("MaxActiveAdjustment", !r.getCellText(44).toString().equals("") ? r.getCellText(44).toString() : "0.001");
		rowItem.put("Locked", !r.getCellText(45).toString().equals("") ? r.getCellText(45).toString() : "0.001");
		rowItem.put("DIStatus", !r.getCellText(46).toString().equals("") ? r.getCellText(46).toString() : "0.001");
		rowItem.put("ESN", !r.getCellText(47).toString().equals("") ? r.getCellText(47).toString() : "0.001");
		rowItem.put("SystemReset", !r.getCellText(48).toString().equals("") ? r.getCellText(48).toString() : "0.001");
		rowItem.put("FastDeviceAccess", !r.getCellText(49).toString().equals("") ? r.getCellText(49).toString() : "0.001");
		rowItem.put("DeviceOperation", !r.getCellText(50).toString().equals("") ? r.getCellText(50).toString() : "0.001");
		rowItem.put("DeviceAccessStatus", !r.getCellText(51).toString().equals("") ? r.getCellText(51).toString() : "0.001");
		rowItem.put("ActivePowerControlMode", !r.getCellText(52).toString().equals("") ? r.getCellText(52).toString() : "0.001");
		rowItem.put("ActivePowerSchedulingTargetValue", !r.getCellText(53).toString().equals("") ? r.getCellText(53).toString() : "0.001");
		rowItem.put("ReactivePowerControlMode", !r.getCellText(54).toString().equals("") ? r.getCellText(54).toString() : "0.001");
		rowItem.put("ReactivePowerSchedulingCurveMode", !r.getCellText(55).toString().equals("") ? r.getCellText(55).toString() : "0.001");
		rowItem.put("ReactivePowerSchedulingTargetValue", !r.getCellText(56).toString().equals("") ? r.getCellText(56).toString() : "0.001");
		rowItem.put("ActiveSchedulingPercentage", !r.getCellText(57).toString().equals("") ? r.getCellText(57).toString() : "0.001");
		rowItem.put("CO2EmissionReductionCoefficient", !r.getCellText(58).toString().equals("") ? r.getCellText(58).toString() : "0.001");
		rowItem.put("PVModuleCapacity", !r.getCellText(59).toString().equals("") ? r.getCellText(59).toString() : "0.001");
		rowItem.put("RatedPlantCapacity", !r.getCellText(60).toString().equals("") ? r.getCellText(60).toString() : "0.001");
		rowItem.put("TotalRatedCapacityOfGridConnectedInverters", !r.getCellText(61).toString().equals("") ? r.getCellText(61).toString() : "0.001");
		rowItem.put("ConversionCoefficient", !r.getCellText(62).toString().equals("") ? r.getCellText(62).toString() : "0.001");
		
		rowItem.put("CommunicationStatus", !r.getCellText(63).toString().equals("") ? r.getCellText(63).toString() : "0.001");
		rowItem.put("AlarmInfo1", !r.getCellText(64).toString().equals("") ? r.getCellText(64).toString() : "0.001");
		rowItem.put("AlarmInfo2", !r.getCellText(65).toString().equals("") ? r.getCellText(65).toString() : "0.001");
		rowItem.put("AlarmInfo3", !r.getCellText(66).toString().equals("") ? r.getCellText(66).toString() : "0.001");
		rowItem.put("nvmActivePower", !r.getCellText(67).toString().equals("") ? r.getCellText(67).toString() : "0.001");
		rowItem.put("nvmActiveEnergy", !r.getCellText(68).toString().equals("") ? r.getCellText(68).toString() : "0.001");
		rowItem.put("MeasuredProduction", !r.getCellText(69).toString().equals("") ? r.getCellText(69).toString() : "0.001");
	...
	public Object setModelGinlongSolisInverterClass6007(HashMap<String, String> rowItem, Row r) {
		rowItem.put("Activeower", !r.getCellText(6).toString().equals("") ? r.getCellText(6).toString() : "0.001");
		rowItem.put("TotalDCoutputpower", !r.getCellText(7).toString().equals("") ? r.getCellText(7).toString() : "0.001");
		rowItem.put("DCVoltage1", !r.getCellText(8).toString().equals("") ? r.getCellText(8).toString() : "0.001");
		rowItem.put("DCcurrent1", !r.getCellText(9).toString().equals("") ? r.getCellText(9).toString() : "0.001");
		rowItem.put("DCVoltage2", !r.getCellText(10).toString().equals("") ? r.getCellText(10).toString() : "0.001");
		rowItem.put("DCcurrent2", !r.getCellText(11).toString().equals("") ? r.getCellText(11).toString() : "0.001");
		rowItem.put("DCVoltage3", !r.getCellText(12).toString().equals("") ? r.getCellText(12).toString() : "0.001");
		rowItem.put("DCcurrent3", !r.getCellText(13).toString().equals("") ? r.getCellText(13).toString() : "0.001");
		rowItem.put("DCVoltage4", !r.getCellText(14).toString().equals("") ? r.getCellText(14).toString() : "0.001");
		rowItem.put("DCcurrent4", !r.getCellText(15).toString().equals("") ? r.getCellText(15).toString() : "0.001");
		rowItem.put("ABlinevoltage", !r.getCellText(16).toString().equals("") ? r.getCellText(16).toString() : "0.001");
		rowItem.put("BClinevoltage", !r.getCellText(17).toString().equals("") ? r.getCellText(17).toString() : "0.001");
		rowItem.put("CAlinevoltage", !r.getCellText(18).toString().equals("") ? r.getCellText(18).toString() : "0.001");
		rowItem.put("AphaseCurrent", !r.getCellText(19).toString().equals("") ? r.getCellText(19).toString() : "0.001");
		rowItem.put("BphaseCurrent", !r.getCellText(20).toString().equals("") ? r.getCellText(20).toString() : "0.001");
		rowItem.put("CphaseCurrent", !r.getCellText(21).toString().equals("") ? r.getCellText(21).toString() : "0.001");
		rowItem.put("Invertertemperature", !r.getCellText(22).toString().equals("") ? r.getCellText(22).toString() : "0.001");
		rowItem.put("GridFrequency", !r.getCellText(23).toString().equals("") ? r.getCellText(23).toString() : "0.001");
		rowItem.put("Inverterstatus", !r.getCellText(24).toString().equals("") ? r.getCellText(24).toString() : "0.001");
		rowItem.put("Actualvalueoflimitedpower", !r.getCellText(25).toString().equals("") ? r.getCellText(25).toString() : "0.001");
		rowItem.put("Reactivepowerhigh16bit", !r.getCellText(26).toString().equals("") ? r.getCellText(26).toString() : "0.001");
		rowItem.put("Reactivepowerlow16bit", !r.getCellText(27).toString().equals("") ? r.getCellText(27).toString() : "0.001");
		rowItem.put("Apparentpowerhigh16bit", !r.getCellText(28).toString().equals("") ? r.getCellText(28).toString() : "0.001");
		rowItem.put("Apparentpowerlow16bit", !r.getCellText(29).toString().equals("") ? r.getCellText(29).toString() : "0.001");
		rowItem.put("Realtimepowerfactor", !r.getCellText(30).toString().equals("") ? r.getCellText(30).toString() : "0.001");
		rowItem.put("TotalEnergy", !r.getCellText(31).toString().equals("") ? r.getCellText(31).toString() : "0.001");
		rowItem.put("nvmActivePower", !r.getCellText(32).toString().equals("") ? r.getCellText(32).toString() : "0.001");
		rowItem.put("nvmActiveEnergy", !r.getCellText(33).toString().equals("") ? r.getCellText(33).toString() : "0.001");
		rowItem.put("MeasuredProduction", !r.getCellText(34).toString().equals("") ? r.getCellText(34).toString() : "0.001");
		
		return rowItem;
	}
	
	
	public Object setModelImtsolarTvClass8004(HashMap<String, String> rowItem, Row r) {
		rowItem.put("irradiance", !r.getCellText(6).toString().equals("") ? r.getCellText(6).toString() : "0.001");
		rowItem.put("tcell", !r.getCellText(7).toString().equals("") ? r.getCellText(7).toString() : "0.001");
		rowItem.put("text", !r.getCellText(8).toString().equals("") ? r.getCellText(8).toString() : "0.001");
		rowItem.put("wspeed", !r.getCellText(9).toString().equals("") ? r.getCellText(9).toString() : "0.001");
		rowItem.put("nvm_irradiance", !r.getCellText(10).toString().equals("") ? r.getCellText(10).toString() : "0.001");
		rowItem.put("nvm_temperature", !r.getCellText(11).toString().equals("") ? r.getCellText(11).toString() : "0.001");
		rowItem.put("nvm_panel_temperature", !r.getCellText(12).toString().equals("") ? r.getCellText(12).toString() : "0.001");
		
		return rowItem;
	}
	
	public Object setModelShark250(HashMap<String, String> rowItem, Row r) {
		rowItem.put("ActivePower", !r.getCellText(6).toString().equals("") ? r.getCellText(6).toString() : "0.001");
		rowItem.put("ReactivePower", !r.getCellText(7).toString().equals("") ? r.getCellText(7).toString() : "0.001");
		rowItem.put("ApparentPower", !r.getCellText(8).toString().equals("") ? r.getCellText(8).toString() : "0.001");
		rowItem.put("ActiveEnergyReceived", !r.getCellText(9).toString().equals("") ? r.getCellText(9).toString() : "0.001");
		rowItem.put("ActiveEnergyDelivered", !r.getCellText(10).toString().equals("") ? r.getCellText(10).toString() : "0.001");
		rowItem.put("ActiveEnergyNet", !r.getCellText(11).toString().equals("") ? r.getCellText(11).toString() : "0.001");
		rowItem.put("ReactiveEnergyReceived", !r.getCellText(12).toString().equals("") ? r.getCellText(12).toString() : "0.001");
		rowItem.put("ReactiveEnergyDelivered", !r.getCellText(13).toString().equals("") ? r.getCellText(13).toString() : "0.001");
		rowItem.put("ReactiveEnergyNet", !r.getCellText(14).toString().equals("") ? r.getCellText(14).toString() : "0.001");
		rowItem.put("ApparentEnergy", !r.getCellText(15).toString().equals("") ? r.getCellText(15).toString() : "0.001");
		rowItem.put("Frequency", !r.getCellText(16).toString().equals("") ? r.getCellText(16).toString() : "0.001");
		rowItem.put("PowerFactor", !r.getCellText(17).toString().equals("") ? r.getCellText(17).toString() : "0.001");
		rowItem.put("ActiveEnergyReceivedRaw", !r.getCellText(18).toString().equals("") ? r.getCellText(18).toString() : "0.001");
		rowItem.put("ActiveEnergyDeliveredRaw", !r.getCellText(19).toString().equals("") ? r.getCellText(19).toString() : "0.001");
		rowItem.put("ActiveEnergyNetRaw", !r.getCellText(20).toString().equals("") ? r.getCellText(20).toString() : "0.001");
		rowItem.put("VoltageAN", !r.getCellText(21).toString().equals("") ? r.getCellText(21).toString() : "0.001");
		rowItem.put("VoltageBN", !r.getCellText(22).toString().equals("") ? r.getCellText(22).toString() : "0.001");
		rowItem.put("VoltageCN", !r.getCellText(23).toString().equals("") ? r.getCellText(23).toString() : "0.001");
		rowItem.put("VoltageAB", !r.getCellText(24).toString().equals("") ? r.getCellText(24).toString() : "0.001");
		rowItem.put("VoltageBC", !r.getCellText(25).toString().equals("") ? r.getCellText(25).toString() : "0.001");
		rowItem.put("VoltageCA", !r.getCellText(26).toString().equals("") ? r.getCellText(26).toString() : "0.001");
		rowItem.put("ACCurrentA", !r.getCellText(27).toString().equals("") ? r.getCellText(27).toString() : "0.001");
		rowItem.put("ACCurrentB", !r.getCellText(28).toString().equals("") ? r.getCellText(28).toString() : "0.001");
		rowItem.put("ACCurrentC", !r.getCellText(29).toString().equals("") ? r.getCellText(29).toString() : "0.001");
		rowItem.put("ACCurrentNeutral", !r.getCellText(30).toString().equals("") ? r.getCellText(30).toString() : "0.001");
		rowItem.put("ActivePowerA", !r.getCellText(31).toString().equals("") ? r.getCellText(31).toString() : "0.001");
		rowItem.put("ActivePowerB", !r.getCellText(32).toString().equals("") ? r.getCellText(32).toString() : "0.001");
		rowItem.put("ActivePowerC", !r.getCellText(33).toString().equals("") ? r.getCellText(33).toString() : "0.001");
		rowItem.put("ReactivePowerA", !r.getCellText(34).toString().equals("") ? r.getCellText(34).toString() : "0.001");
		rowItem.put("ReactivePowerB", !r.getCellText(35).toString().equals("") ? r.getCellText(35).toString() : "0.001");
		rowItem.put("ReactivePowerC", !r.getCellText(36).toString().equals("") ? r.getCellText(36).toString() : "0.001");
		rowItem.put("PowerFactorA", !r.getCellText(37).toString().equals("") ? r.getCellText(37).toString() : "0.001");
		rowItem.put("PowerFactorB", !r.getCellText(38).toString().equals("") ? r.getCellText(38).toString() : "0.001");
		rowItem.put("PowerFactorC", !r.getCellText(39).toString().equals("") ? r.getCellText(39).toString() : "0.001");
		rowItem.put("Serialnumber", !r.getCellText(40).toString().equals("") ? r.getCellText(40).toString() : "0.001");
		rowItem.put("Firmwareversion", !r.getCellText(41).toString().equals("") ? r.getCellText(41).toString() : "0.001");
		rowItem.put("CurrentTransformerPrimary", !r.getCellText(42).toString().equals("") ? r.getCellText(42).toString() : "0.001");
		rowItem.put("PotentialTransformerPrimary", !r.getCellText(43).toString().equals("") ? r.getCellText(43).toString() : "0.001");
		rowItem.put("PotentialTransformerSecondary", !r.getCellText(44).toString().equals("") ? r.getCellText(44).toString() : "0.001");
		rowItem.put("CurrentTransformerSecondary", !r.getCellText(45).toString().equals("") ? r.getCellText(45).toString() : "0.001");
		
		rowItem.put("nvmActivePower", !r.getCellText(46).toString().equals("") ? r.getCellText(46).toString() : "0.001");
		rowItem.put("nvmActiveEnergy", !r.getCellText(47).toString().equals("") ? r.getCellText(47).toString() : "0.001");
		rowItem.put("MeasuredProduction", !r.getCellText(48).toString().equals("") ? r.getCellText(48).toString() : "0.001");
		return rowItem;
	}
