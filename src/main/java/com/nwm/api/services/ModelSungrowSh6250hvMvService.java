...
public class ModelSungrowSh6250hvMvService extends DB {
	...
	public void checkTriggerAlert(ModelSungrowSh6250hvMvEntity obj) {
		try {
			processAlert(obj, obj.getM1_alarm_state_accircuitbreakerabnormal(), 2553);
			processAlert(obj, obj.getM1_alarm_state_acspdalarm(), 2554);
			processAlert(obj, obj.getM1_alarm_state_antipidpowersupplyabnormal(), 2555);
			processAlert(obj, obj.getM1_alarm_state_bypasscircuitbreakerabnormal(), 2556);
			processAlert(obj, obj.getM1_alarm_state_bypassfuseabnormal(), 2557);
			processAlert(obj, obj.getM1_alarm_state_contactorcontactabnormal(), 2558);
			processAlert(obj, obj.getM1_alarm_state_ctunbalance(), 2559);
			processAlert(obj, obj.getM1_alarm_state_dcbypassforwardovercurrentalarm(), 2560);
			processAlert(obj, obj.getM1_alarm_state_dcbypassreserveovercurrentalarm(), 2561);
			processAlert(obj, obj.getM1_alarm_state_dcfuseabnormal(), 2562);
			processAlert(obj, obj.getM1_alarm_state_dcsensorabnormal(), 2563);
			processAlert(obj, obj.getM1_alarm_state_dcspdalarm(), 2564);
			processAlert(obj, obj.getM1_alarm_state_dcswitchabnormal(), 2565);
			processAlert(obj, obj.getM1_alarm_state_dspmdccommunicationabnormal(), 2566);
			processAlert(obj, obj.getM1_alarm_state_energymetercommunicationabnormal(), 2567);
			processAlert(obj, obj.getM1_alarm_state_externalpowersupplyabnormal(), 2568);
			processAlert(obj, obj.getM1_alarm_state_fan2anomaly(), 2569);
			processAlert(obj, obj.getM1_alarm_state_fanabnormal(), 2570);
			processAlert(obj, obj.getM1_alarm_state_frequencydeviationactivepowerregulation(), 2571);
			processAlert(obj, obj.getM1_alarm_state_gfrtoperation(), 2572);
			processAlert(obj, obj.getM1_alarm_state_groundfuseabnormal(), 2573);
			processAlert(obj, obj.getM1_alarm_state_insulationboardcommunicationanomaly(), 2574);
			processAlert(obj, obj.getM1_alarm_state_lowinsulationresistance(), 2575);
			processAlert(obj, obj.getM1_alarm_state_temperatureabnormalalarm(), 2576);
			processAlert(obj, obj.getM1_alarm_state_temperatureandhumidityboardcommerror(), 2577);
			processAlert(obj, obj.getM1_alarm_state_tributaryboardcommunicationerror(), 2578);
			processAlert(obj, obj.getM1_alarm_state_voltagedeviationreactivepowerregulation(), 2579);
			processAlert(obj, obj.getM1_fault_state_1_acleakagecurrentprotection(), 2580);
			processAlert(obj, obj.getM1_fault_state_1_acovercurrent(), 2581);
			processAlert(obj, obj.getM1_fault_state_1_acovervoltage(), 2582);
			processAlert(obj, obj.getM1_fault_state_1_acundervoltage(), 2583);
			processAlert(obj, obj.getM1_fault_state_1_busovervoltage(), 2584);
			processAlert(obj, obj.getM1_fault_state_1_busundervoltage(), 2585);
			processAlert(obj, obj.getM1_fault_state_1_contactorfault(), 2586);
			processAlert(obj, obj.getM1_fault_state_1_dcfusefault(), 2587);
			processAlert(obj, obj.getM1_fault_state_1_dcleakagecurrentprotection(), 2588);
			processAlert(obj, obj.getM1_fault_state_1_dcovercurrent(), 2589);
			processAlert(obj, obj.getM1_fault_state_1_dcovervoltage(), 2590);
			processAlert(obj, obj.getM1_fault_state_1_dcundervoltage(), 2591);
			processAlert(obj, obj.getM1_fault_state_1_detectionfusefault(), 2592);
			processAlert(obj, obj.getM1_fault_state_1_fanfault(), 2593);
			processAlert(obj, obj.getM1_fault_state_1_frequencyabnormal(), 2594);
			processAlert(obj, obj.getM1_fault_state_1_gfdiprotection(), 2595);
			processAlert(obj, obj.getM1_fault_state_1_groundingfault(), 2596);
			processAlert(obj, obj.getM1_fault_state_1_hardwarefault(), 2597);
			processAlert(obj, obj.getM1_fault_state_1_inverterovervoltage(), 2598);
			processAlert(obj, obj.getM1_fault_state_1_islandingprotection(), 2599);
			processAlert(obj, obj.getM1_fault_state_1_moduleovertemperature(), 2600);
			processAlert(obj, obj.getM1_fault_state_1_overfrequency(), 2601);
			processAlert(obj, obj.getM1_fault_state_1_overloadprotection(), 2602);
			processAlert(obj, obj.getM1_fault_state_1_pdpprotection(), 2603);
			processAlert(obj, obj.getM1_fault_state_1_reactorovertemperature(), 2604);
			processAlert(obj, obj.getM1_fault_state_1_sensorfailure(), 2605);
			processAlert(obj, obj.getM1_fault_state_1_temperatureabnormal(), 2606);
			processAlert(obj, obj.getM1_fault_state_1_transformerovertemperature(), 2607);
			processAlert(obj, obj.getM1_fault_state_1_underfrequency(), 2608);
			processAlert(obj, obj.getM1_fault_state_2_accurrentunbalance(), 2609);
			processAlert(obj, obj.getM1_fault_state_2_acspdfault(), 2610);
			processAlert(obj, obj.getM1_fault_state_2_dcspdfault(), 2611);
			processAlert(obj, obj.getM1_fault_state_2_pvpolarityreversed(), 2612);
			processAlert(obj, obj.getM1_fault_state_2_accabinetovertemperature(), 2613);
			processAlert(obj, obj.getM1_fault_state_2_acfusefault(), 2614);
			processAlert(obj, obj.getM1_fault_state_2_acswitchdisconnection(), 2615);
			processAlert(obj, obj.getM1_fault_state_2_acswitchfault(), 2616);
			processAlert(obj, obj.getM1_fault_state_2_backuppowersupplyabnormal(), 2617);
			processAlert(obj, obj.getM1_fault_state_2_buffercontactorfault(), 2618);
			processAlert(obj, obj.getM1_fault_state_2_carriersyncfault(), 2619);
			processAlert(obj, obj.getM1_fault_state_2_controlcabinettemperatureabnormal(), 2620);
			processAlert(obj, obj.getM1_fault_state_2_controlpowersupplyabnormal(), 2621);
			processAlert(obj, obj.getM1_fault_state_2_currentunbalance2(), 2622);
			processAlert(obj, obj.getM1_fault_state_2_currentunbalance3(), 2623);
			processAlert(obj, obj.getM1_fault_state_2_dccabinetovertemperature(), 2624);
			processAlert(obj, obj.getM1_fault_state_2_dcfusegroundingfault(), 2625);
			processAlert(obj, obj.getM1_fault_state_2_dcinjectionfault(), 2626);
			processAlert(obj, obj.getM1_fault_state_2_dcswitchfault(), 2627);
			processAlert(obj, obj.getM1_fault_state_2_dcvoltagesamplingfault(), 2628);
			processAlert(obj, obj.getM1_fault_state_2_devicecoderepeatfault(), 2629);
			processAlert(obj, obj.getM1_fault_state_2_driveboardfault(), 2630);
			processAlert(obj, obj.getM1_fault_state_2_fan2fault(), 2631);
			processAlert(obj, obj.getM1_fault_state_2_gridvoltageunbalance(), 2632);
			processAlert(obj, obj.getM1_fault_state_2_insulationimpedance(), 2633);
			processAlert(obj, obj.getM1_fault_state_2_neutralpointpotentialshift(), 2634);
			processAlert(obj, obj.getM1_fault_state_2_paralleloperation(), 2635);
			processAlert(obj, obj.getM1_fault_state_2_samplingfault(), 2636);
			processAlert(obj, obj.getM1_fault_state_2_softstartfault(), 2637);
			processAlert(obj, obj.getM1_node_state_1_acbfaultstate(), 2641);
			processAlert(obj, obj.getM1_work_state_emergencystop(), 2641);
			processAlert(obj, obj.getM1_work_state_faultstop(), 2642);
			processAlert(obj, obj.getM1_work_state_iodspcommunicationabnormal(), 2643);
			processAlert(obj, obj.getM1_work_state_iomdccommunicationabnormal(), 2644);
			processAlert(obj, obj.getM1_work_state_stopped(), 2645);
			processAlert(obj, obj.getM2_alarm_state_accircuitbreakerabnormal(), 2646);
			processAlert(obj, obj.getM2_alarm_state_acspdalarm(), 2647);
			processAlert(obj, obj.getM2_alarm_state_antipidpowersupplyabnormal(), 2648);
			processAlert(obj, obj.getM2_alarm_state_bypasscircuitbreakerabnormal(), 2649);
			processAlert(obj, obj.getM2_alarm_state_bypassfuseabnormal(), 2650);
			processAlert(obj, obj.getM2_alarm_state_contactorcontactabnormal(), 2651);
			processAlert(obj, obj.getM2_alarm_state_ctunbalance(), 2652);
			processAlert(obj, obj.getM2_alarm_state_dcbypassforwardovercurrentalarm(), 2653);
			processAlert(obj, obj.getM2_alarm_state_dcbypassreserveovercurrentalarm(), 2654);
			processAlert(obj, obj.getM2_alarm_state_dcfuseabnormal(), 2655);
			processAlert(obj, obj.getM2_alarm_state_dcsensorabnormal(), 2656);
			processAlert(obj, obj.getM2_alarm_state_dcspdalarm(), 2657);
			processAlert(obj, obj.getM2_alarm_state_dcswitchabnormal(), 2658);
			processAlert(obj, obj.getM2_alarm_state_dspmdccommunicationabnormal(), 2659);
			processAlert(obj, obj.getM2_alarm_state_energymetercommunicationabnormal(), 2660);
			processAlert(obj, obj.getM2_alarm_state_externalpowersupplyabnormal(), 2661);
			processAlert(obj, obj.getM2_alarm_state_fan2anomaly(), 2662);
			processAlert(obj, obj.getM2_alarm_state_fanabnormal(), 2663);
			processAlert(obj, obj.getM2_alarm_state_frequencydeviationactivepowerregulation(), 2664);
			processAlert(obj, obj.getM2_alarm_state_gfrtoperation(), 2665);
			processAlert(obj, obj.getM2_alarm_state_groundfuseabnormal(), 2666);
			processAlert(obj, obj.getM2_alarm_state_insulationboardcommunicationanomaly(), 2667);
			processAlert(obj, obj.getM2_alarm_state_lowinsulationresistance(), 2668);
			processAlert(obj, obj.getM2_alarm_state_temperatureabnormalalarm(), 2669);
			processAlert(obj, obj.getM2_alarm_state_temperatureandhumidityboardcommerror(), 2670);
			processAlert(obj, obj.getM2_alarm_state_tributaryboardcommunicationerror(), 2671);
			processAlert(obj, obj.getM2_alarm_state_voltagedeviationreactivepowerregulation(), 2672);
			processAlert(obj, obj.getM2_fault_state_1_acleakagecurrentprotection(), 2673);
			processAlert(obj, obj.getM2_fault_state_1_acovercurrent(), 2674);
			processAlert(obj, obj.getM2_fault_state_1_acovervoltage(), 2675);
			processAlert(obj, obj.getM2_fault_state_1_acundervoltage(), 2676);
			processAlert(obj, obj.getM2_fault_state_1_busovervoltage(), 2677);
			processAlert(obj, obj.getM2_fault_state_1_busundervoltage(), 2678);
			processAlert(obj, obj.getM2_fault_state_1_contactorfault(), 2679);
			processAlert(obj, obj.getM2_fault_state_1_dcfusefault(), 2680);
			processAlert(obj, obj.getM2_fault_state_1_dcleakagecurrentprotection(), 2681);
			processAlert(obj, obj.getM2_fault_state_1_dcovercurrent(), 2682);
			processAlert(obj, obj.getM2_fault_state_1_dcovervoltage(), 2683);
			processAlert(obj, obj.getM2_fault_state_1_dcundervoltage(), 2684);
			processAlert(obj, obj.getM2_fault_state_1_detectionfusefault(), 2685);
			processAlert(obj, obj.getM2_fault_state_1_fanfault(), 2686);
			processAlert(obj, obj.getM2_fault_state_1_frequencyabnormal(), 2687);
			processAlert(obj, obj.getM2_fault_state_1_gfdiprotection(), 2688);
			processAlert(obj, obj.getM2_fault_state_1_groundingfault(), 2689);
			processAlert(obj, obj.getM2_fault_state_1_hardwarefault(), 2690);
			processAlert(obj, obj.getM2_fault_state_1_inverterovervoltage(), 2691);
			processAlert(obj, obj.getM2_fault_state_1_islandingprotection(), 2692);
			processAlert(obj, obj.getM2_fault_state_1_moduleovertemperature(), 2693);
			processAlert(obj, obj.getM2_fault_state_1_overfrequency(), 2694);
			processAlert(obj, obj.getM2_fault_state_1_overloadprotection(), 2695);
			processAlert(obj, obj.getM2_fault_state_1_pdpprotection(), 2696);
			processAlert(obj, obj.getM2_fault_state_1_reactorovertemperature(), 2697);
			processAlert(obj, obj.getM2_fault_state_1_sensorfailure(), 2698);
			processAlert(obj, obj.getM2_fault_state_1_temperatureabnormal(), 2699);
			processAlert(obj, obj.getM2_fault_state_1_transformerovertemperature(), 2700);
			processAlert(obj, obj.getM2_fault_state_1_underfrequency(), 2701);
			processAlert(obj, obj.getM2_fault_state_2_accurrentunbalance(), 2702);
			processAlert(obj, obj.getM2_fault_state_2_acspdfault(), 2703);
			processAlert(obj, obj.getM2_fault_state_2_dcspdfault(), 2704);
			processAlert(obj, obj.getM2_fault_state_2_pvpolarityreversed(), 2705);
			processAlert(obj, obj.getM2_fault_state_2_accabinetovertemperature(), 2706);
			processAlert(obj, obj.getM2_fault_state_2_acfusefault(), 2707);
			processAlert(obj, obj.getM2_fault_state_2_acswitchdisconnection(), 2708);
			processAlert(obj, obj.getM2_fault_state_2_acswitchfault(), 2709);
			processAlert(obj, obj.getM2_fault_state_2_backuppowersupplyabnormal(), 2710);
			processAlert(obj, obj.getM2_fault_state_2_buffercontactorfault(), 2711);
			processAlert(obj, obj.getM2_fault_state_2_carriersyncfault(), 2712);
			processAlert(obj, obj.getM2_fault_state_2_controlcabinettemperatureabnormal(), 2713);
			processAlert(obj, obj.getM2_fault_state_2_controlpowersupplyabnormal(), 2714);
			processAlert(obj, obj.getM2_fault_state_2_currentunbalance2(), 2715);
			processAlert(obj, obj.getM2_fault_state_2_currentunbalance3(), 2716);
			processAlert(obj, obj.getM2_fault_state_2_dccabinetovertemperature(), 2717);
			processAlert(obj, obj.getM2_fault_state_2_dcfusegroundingfault(), 2718);
			processAlert(obj, obj.getM2_fault_state_2_dcinjectionfault(), 2719);
			processAlert(obj, obj.getM2_fault_state_2_dcswitchfault(), 2720);
			processAlert(obj, obj.getM2_fault_state_2_dcvoltagesamplingfault(), 2721);
			processAlert(obj, obj.getM2_fault_state_2_devicecoderepeatfault(), 2722);
			processAlert(obj, obj.getM2_fault_state_2_driveboardfault(), 2723);
			processAlert(obj, obj.getM2_fault_state_2_fan2fault(), 2724);
			processAlert(obj, obj.getM2_fault_state_2_gridvoltageunbalance(), 2725);
			processAlert(obj, obj.getM2_fault_state_2_insulationimpedance(), 2726);
			processAlert(obj, obj.getM2_fault_state_2_neutralpointpotentialshift(), 2727);
			processAlert(obj, obj.getM2_fault_state_2_paralleloperation(), 2728);
			processAlert(obj, obj.getM2_fault_state_2_samplingfault(), 2729);
			processAlert(obj, obj.getM2_fault_state_2_softstartfault(), 2730);
			processAlert(obj, obj.getM2_node_state_1_accircuitbreakerstate(), 2731);
			processAlert(obj, obj.getM2_node_state_1_acfusestatus(), 2732);
			processAlert(obj, obj.getM2_node_state_1_acmaincontactorstate(), 2733);
			processAlert(obj, obj.getM2_node_state_1_acbfaultstate(), 2734);
			processAlert(obj, obj.getM2_node_state_1_acbremotelocal(), 2735);
			processAlert(obj, obj.getM2_node_state_2_dcswitchstate1(), 2736);
			processAlert(obj, obj.getM2_node_state_2_dcswitchstate2(), 2737);
			processAlert(obj, obj.getM2_node_state_2_dcswitchstate3(), 2738);
			processAlert(obj, obj.getM2_node_state_2_dcswitchstate4(), 2739);
			processAlert(obj, obj.getM2_node_state_2_spdnodestate(), 2740);
			processAlert(obj, obj.getM2_work_state_alarmrunning(), 2741);
			processAlert(obj, obj.getM2_work_state_antipidrunning(), 2742);
			processAlert(obj, obj.getM2_work_state_deratingrunning(), 2743);
			processAlert(obj, obj.getM2_work_state_emergencystop(), 2744);
			processAlert(obj, obj.getM2_work_state_faultstop(), 2745);
			processAlert(obj, obj.getM2_work_state_initialstandby(), 2746);
			processAlert(obj, obj.getM2_work_state_iodspcommunicationabnormal(), 2747);
			processAlert(obj, obj.getM2_work_state_iomdccommunicationabnormal(), 2748);
			processAlert(obj, obj.getM2_work_state_keystop(), 2749);
			processAlert(obj, obj.getM2_work_state_running(), 2750);
			processAlert(obj, obj.getM2_work_state_standby(), 2751);
			processAlert(obj, obj.getM2_work_state_starting(), 2752);
			processAlert(obj, obj.getM2_work_state_stopped(), 2753);
			processAlert(obj, obj.getM2_work_state_stopping(), 2754);
			processAlert(obj, obj.getM2_work_state_totalsignalbitofrunningstate(), 2755);
			processAlert(obj, obj.getM2_work_state_totalstopbit(), 2756);
			processAlert(obj, obj.getMv_node_state_external_e_stop(), 2757);
			processAlert(obj, obj.getMv_node_state_gas_relay_alarm(), 2758);
			processAlert(obj, obj.getMv_node_state_gas_relay_trip(), 2759);
			processAlert(obj, obj.getMv_node_state_hv_remote_ctrl(), 2760);
			processAlert(obj, obj.getMv_node_state_hv_remote_ctrl_trip(), 2761);
			processAlert(obj, obj.getMv_node_state_hv_room_smoke(), 2762);
			processAlert(obj, obj.getMv_node_state_low_oil_level_trip(), 2763);
			processAlert(obj, obj.getMv_node_state_mv_ds(), 2764);
			processAlert(obj, obj.getMv_node_state_mv_fuse(), 2765);
			processAlert(obj, obj.getMv_node_state_mv_load_switch(), 2766);
			processAlert(obj, obj.getMv_node_state_mv_load_switch_1(), 2767);
			processAlert(obj, obj.getMv_node_state_mv_load_switch_2(), 2768);
			processAlert(obj, obj.getMv_node_state_mv_vcb(), 2769);
			processAlert(obj, obj.getMv_node_state_oil_temp_alarrm(), 2770);
			processAlert(obj, obj.getMv_node_state_oil_temp_trip(), 2771);
			processAlert(obj, obj.getMv_node_state_pressure_relief_trip(), 2772);
			processAlert(obj, obj.getMv_node_state_sf6_low_press_alarm(), 2773);
			processAlert(obj, obj.getMv_node_state_winding_temp_alarm(), 2774);
			processAlert(obj, obj.getMv_node_state_winding_temp_trip(), 2775);
			processAlert(obj, obj.getWork_state_door_open_prot(), 2776);
			processAlert(obj, obj.getWork_state_external_emer_stop(), 2777);
			processAlert(obj, obj.getWork_state_local_emer_stop(), 2778);
			processAlert(obj, obj.getWork_state_mv_fault(), 2779);
			processAlert(obj, obj.getWork_state_rem_emer_stop(), 2780);
			processAlert(obj, obj.getWork_state_running(), 2781);
			processAlert(obj, obj.getWork_state_smoke_prot(), 2782);
			processAlert(obj, obj.getWork_state_stopped(), 2783);
