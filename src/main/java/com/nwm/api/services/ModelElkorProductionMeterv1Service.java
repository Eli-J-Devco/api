...
public class ModelElkorProductionMeterv1Service extends DB {

	/**
	 * @description set data ModelElkorProductionMeterv1
	 * @author long.pham
	 * @since 2022-12-20
	 * @param data
	 */
	...
	public ModelElkorProductionMeterv1Entity setModelElkorProductionMeterv1(String line, double offset_data_old) {
		try {
			...
			if (words.size() > 0) {
				ModelElkorProductionMeterv1Entity dataModelElkorP = new ModelElkorProductionMeterv1Entity();
				...
				dataModelElkorP.setNetTotalEnergy(energy);
				...
				return new ModelElkorProductionMeterv1Entity();
			}
			...
			ModelElkorProductionMeterv1Entity dataObj = (ModelElkorProductionMeterv1Entity) queryForObject("ModelElkorProductionMeterv1.getLastRow", obj);
			 ...
			 if(dataObj != null && dataObj.getId_device() > 0 && dataObj.getNvmActiveEnergy() > 0 && obj.getNvmActiveEnergy() > 0 && obj.getNvmActiveEnergy() != 0.001 ) {
				 ...
				 if(obj.getNvmActiveEnergy() == 0.001 || obj.getNvmActiveEnergy() < 0) {
					 ...
					 obj.setNetTotalEnergy(dataObj.getNvmActiveEnergy());
				 }
			 }

			 obj.setMeasuredProduction(measuredProduction);
			 
			 Object insertId = insert("ModelElkorProductionMeterv1.insertModelElkorProductionMeterv1", obj);
		        if(insertId == null ) {
		        	return false;
		        }
		        return true;
