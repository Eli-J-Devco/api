...
//		List dataList = new ArrayList();
//		try {
//			dataList = queryForList("CronJobAlert.getListSite", obj);
//			if (dataList == null)
//				return new ArrayList();
//		} catch (Exception ex) {
//			return new ArrayList();
...
//		List dataList = new ArrayList();
//		try {
//			dataList = queryForList("CronJobAlert.getListDeviceSolarOpenWeather", obj);
//			if (dataList == null)
//				return new ArrayList();
//		} catch (Exception ex) {
//			return new ArrayList();
...
//		List dataList = new ArrayList();
//		try {
//			dataList = queryForList("CronJobAlert.getListDeviceBySite", obj);
//			if (dataList == null)
//				return new ArrayList();
//		} catch (Exception ex) {
//			return new ArrayList();
...
//		List dataList = new ArrayList();
//		try {
//			dataList = queryForList("CronJobAlert.getListMeterAndInverter", obj);
//			if (dataList == null)
//				return new ArrayList();
//		} catch (Exception ex) {
//			return new ArrayList();
...
//		try {
//			rowItem = (DeviceEntity) queryForObject("CronJobAlert.getLastValueLifetime", obj);
//			if (rowItem == null)
//				return new DeviceEntity();
//		} catch (Exception ex) {
//			log.error("CronJobAlert.getLastValueLifetime", ex);
//			return new DeviceEntity();
//		}
//		return rowItem;
//	}
...
//		try {
//			return update("CronJobAlert.updateDataDeviceLifetime", obj) > 0;
//		} catch (Exception ex) {
...
//		DeviceEntity rowItem = new DeviceEntity();
//		try {
//			rowItem = (DeviceEntity) queryForObject("CronJobAlert.getLastValueEnergyToday", obj);
//			if (rowItem == null)
//				return new DeviceEntity();
//		} catch (Exception ex) {
//			log.error("CronJobAlert.getLastValueEnergyToday", ex);
//			return new DeviceEntity();
//		}
//		return rowItem;
//	}
...
//		DeviceEntity rowItem = new DeviceEntity();
//		try {
//			rowItem = (DeviceEntity) queryForObject("CronJobAlert.getDataDeviceEnergyThisMonth", obj);
//			if (rowItem == null)
//				return new DeviceEntity();
//		} catch (Exception ex) {
//			log.error("CronJobAlert.getDataDeviceEnergyThisMonth", ex);
//			return new DeviceEntity();
//		}
//		return rowItem;
//	}
...
//		try {
//			return update("CronJobAlert.updateDataDeviceEnergyToday", obj) > 0;
//		} catch (Exception ex) {
...
//		try {
//			return update("CronJobAlert.updateDataDeviceEnergyThisMonth", obj) > 0;
//		} catch (Exception ex) {
...
//		List dataList = new ArrayList();
//		try {
//			dataList = queryForList("CronJobAlert.getListDevice", obj);
//			if (dataList == null)
//				return new ArrayList();
//		} catch (Exception ex) {
//			return new ArrayList();
...
//		try {
//			rowItem = (ErrorEntity) queryForObject("CronJobAlert.getErrorItem", obj);
//			if (rowItem == null)
//				return new ErrorEntity();
//		} catch (Exception ex) {
//			log.error("CronJobAlert.getErrorItem", ex);
//			return new ErrorEntity();
//		}
//		return rowItem;
//	}
...
//		List dataList = new ArrayList();
//		try {
//			dataList = queryForList("CronJobAlert.getListAlertCronJob", obj);
//			if (dataList == null)
//				return new ArrayList();
//		} catch (Exception ex) {
//			return new ArrayList();
...
//		BatchJobTableEntity rowItem = new BatchJobTableEntity();
//		try {
//			rowItem = (BatchJobTableEntity) queryForObject("CronJobAlert.getLastRowItemAutoCloseAlert", obj);
//			if (rowItem == null)
//				return new BatchJobTableEntity();
//		} catch (Exception ex) {
//			log.error("CronJobAlert.getLastRowItemAutoCloseAlert", ex);
//			return new BatchJobTableEntity();
//		}
//		return rowItem;
//	}
...
//		try{
//			return update("CronJobAlert.updateWeather", obj)>0;
//		}catch (Exception ex) {
//			log.error("CronJobAlert.updateWeather", ex);
//			return false;
//		}
//	}
//	
...
//		try{
//			return update("CronJobAlert.updateSunriseSunset", obj)>0;
//		}catch (Exception ex) {
//			log.error("CronJobAlert.updateSunriseSunset", ex);
//			return false;
//		}
//	}
//	
...
//		try {
//			return update("CronJobAlert.deleteAlert", obj) > 0;
//		} catch (Exception ex) {
//			log.error("CronJobAlert.deleteAlert", ex);
//			return false;
//		}
//	}
//	
...
//		try
//	    {
//			List dataListInverter = queryForList("CronJobAlert.getListDeviceInverterBySite", obj);
//			List dataListMeter = queryForList("CronJobAlert.getListDeviceMeterBySite", obj);
//			List dataListWeather = queryForList("CronJobAlert.getListDeviceWeather", obj);
//			
//			Date now = new Date();
...
//						
//						
//						dataReportInverter = (SiteDataReportEntity) queryForObject("CronJobAlert.getSiteDataReportIIMW", deviceItem);
//						if (dataReportInverter != null && dataReportInverter.getId_device() > 0) {
//							insert("CronJobAlert.insertSiteDataReport", dataReportInverter);
//						}
//					}
//					
//					// meter 
...
//						
//						dataReportMeter = (SiteDataReportEntity) queryForObject("CronJobAlert.getSiteDataReportMIMW", deviceItemMeter);
//						if (dataReportMeter != null && dataReportMeter.getId_device() > 0) {
//							insert("CronJobAlert.insertSiteDataReport", dataReportMeter);
//						}
//					}
//					
//					// weather station
...
//						
//						dataReportMeter = (SiteDataReportEntity) queryForObject("CronJobAlert.getSiteDataReportWeather", deviceItemWeather);
//						if (dataReportMeter != null && dataReportMeter.getId_device() > 0) {
//							insert("CronJobAlert.insertSiteDataReport", dataReportMeter);
//						}
//					}
...
//						deviceItem.setEnd_date(dateFormat.format(cal.getTime())+ " 17:59:59");
//						
//						dataReportInverter = (SiteDataReportEntity) queryForObject("CronJobAlert.getSiteDataReportIIM", deviceItem);
//						if (dataReportInverter != null && dataReportInverter.getId_device() > 0) {
//							insert("CronJobAlert.insertSiteDataReport", dataReportInverter);
//						}
//					}
...
//						deviceItemMeter.setEnd_date(dateFormat.format(cal.getTime())+ " 17:59:59");
//
//						dataReportMeter = (SiteDataReportEntity) queryForObject("CronJobAlert.getSiteDataReportMIM", deviceItemMeter);
//						if (dataReportMeter != null && dataReportMeter.getId_device() > 0) {
//							insert("CronJobAlert.insertSiteDataReport", dataReportMeter);
//						}
//					}
...
//						deviceItemMeter.setEnd_date(dateFormat.format(cal.getTime())+ " 17:59:59");
//
//						dataReportMeter = (SiteDataReportEntity) queryForObject("CronJobAlert.getSiteDataReportMM", deviceItemMeter);
//						if (dataReportMeter != null && dataReportMeter.getId_device() > 0) {
//							insert("CronJobAlert.insertSiteDataReport", dataReportMeter);
//						}
//					}
...
//						deviceItem.setEnd_date(dateFormat.format(cal.getTime())+ " 17:59:59");
//						
//						dataReportInverter = (SiteDataReportEntity) queryForObject("CronJobAlert.getSiteDataReportIIW", deviceItem);
//						if (dataReportInverter != null && dataReportInverter.getId_device() > 0) {
//							insert("CronJobAlert.insertSiteDataReport", dataReportInverter);
//						}
//					}
...
//				dataWeatherStatiton =  (SiteEntity) queryForObject("CronJobAlert.getDataIrradianceYesterday", obj);
...
//					dataMeter = (SiteEntity) queryForObject("CronJobAlert.getDataPowerMeterYesterday", obj);
//					if(dataMeter != null) {
...
//					dataInverter = (SiteEntity) queryForObject("CronJobAlert.getDataPowerInverterYesterday", obj);
...
//			update("CronJobAlert.updatPerformanceRatioYesterday", obj);
//			return null;
//	    }
//	    catch(Exception ex)
//	    {
...
//		List dataList = new ArrayList();
//		try {
//			dataList = queryForList("CronJobAlert.getListReportsByCadence", obj);
//			if (dataList == null)
//				return new ArrayList();
//		} catch (Exception ex) {
//			return new ArrayList();
...
//		DeviceEntity rowItem = new DeviceEntity();
//		try {
//			rowItem = (DeviceEntity) queryForObject("CronJobAlert.checkExitsDeviceUploadSungrow", obj);
//			if (rowItem == null)
//				return new DeviceEntity();
//		} catch (Exception ex) {
//			log.error("CronJobAlert.checkExitsDeviceUploadSungrow", ex);
//			return new DeviceEntity();
//		}
//		return rowItem;
//	}
...
//		DeviceEntity rowItem = new DeviceEntity();
//		try {
//			rowItem = (DeviceEntity) queryForObject("CronJobAlert.checkExitsDeviceSMA", obj);
//			if (rowItem == null)
//				return new DeviceEntity();
//		} catch (Exception ex) {
//			log.error("CronJobAlert.checkExitsDeviceSMA", ex);
//			return new DeviceEntity();
//		}
//		return rowItem;
//	}
...
//		List dataList = new ArrayList();
//		try {
//			dataList = queryForList("CronJobAlert.getListDeviceCelModem", obj);
//			if (dataList == null)
//				return new ArrayList();
//		} catch (Exception ex) {
//			return new ArrayList();
...
//		List dataList = new ArrayList();
//		try {
//			dataList = queryForList("CronJobAlert.getListDeviceDatalogger", obj);
//			if (dataList == null)
//				return new ArrayList();
//		} catch (Exception ex) {
//			return new ArrayList();
...
//		List dataList = new ArrayList();
//		try {
//			dataList = queryForList("CronJobAlert.getListSiteByDataloggerType", obj);
//			if (dataList == null)
//				return new ArrayList();
//		} catch (Exception ex) {
//			return new ArrayList();
...
//		try {
//			device = (DeviceEntity) queryForObject("CronJobAlert.getDeviceDetailByModbus", obj);
//			if (device == null)
//				return new DeviceEntity();
//		} catch (Exception ex) {
//			return new DeviceEntity();
...
//		List dataList = new ArrayList();
//		try {
//			dataList = queryForList("CronJobAlert.getListDeviceSMABySite", obj);
//			if (dataList == null)
//				return new ArrayList();
//		} catch (Exception ex) {
//			return new ArrayList();
...
//		List dataList = new ArrayList();
//		try {
//			dataList = queryForList("CronJobAlert.getListDeviceUpdateLastUpdate", obj);
//			if (dataList == null)
//				return new ArrayList();
//		} catch (Exception ex) {
//			return new ArrayList();
...
//		BatchJobTableEntity rowItem = new BatchJobTableEntity();
//		try {
//			rowItem = (BatchJobTableEntity) queryForObject("CronJobAlert.getLastRowItemUpdateDate", obj);
//			if (rowItem == null)
//				return new BatchJobTableEntity();
//		} catch (Exception ex) {
//			log.error("CronJobAlert.getLastRowItem", ex);
...
//		try {
//			return update("CronJobAlert.updateLastUpdatedCronJob", obj) > 0;
//		} catch (Exception ex) {
//			log.error("CronJobAlert.updateLastUpdatedCronJob", ex);
//			return false;
//		}
//	}
//	
